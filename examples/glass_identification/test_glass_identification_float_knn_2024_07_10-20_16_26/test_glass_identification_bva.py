...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_glass_identification_bva_experiment_data.json')
...
class TestGlassIdentificationProperty:
    ...
    @given(st.floats(min_value=1.515026, max_value=1.515994, allow_nan=False),
           st.floats(min_value=14.413, max_value=15.333, allow_nan=False),
           st.sampled_from([2.71, 3.42, 3.46, 3.5, 3.55, 3.6, 3.61, 3.62, 3.73, 3.75]),
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
           ...
           st.floats(min_value=9.47, max_value=10.479, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
    ...
    @given(st.floats(min_value=1.515026, max_value=1.515994, allow_nan=False),
           st.floats(min_value=15.336, max_value=15.744, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.515997, max_value=1.516211, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
           st.floats(min_value=72.141, max_value=72.723, allow_nan=False),
    ...
    @given(st.floats(min_value=1.515997, max_value=1.516211, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
           st.floats(min_value=72.726, max_value=72.757, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.515997, max_value=1.516211, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.121, max_value=12.468, allow_nan=False),
           st.floats(min_value=2.632, max_value=3.289, allow_nan=False),
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
           st.floats(min_value=72.886, max_value=73.39, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.515997, max_value=1.516211, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.471, max_value=13.452, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.632, max_value=3.289, allow_nan=False),
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
           st.floats(min_value=72.886, max_value=73.39, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.515997, max_value=1.516211, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.292, max_value=3.531, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
           st.floats(min_value=72.886, max_value=73.39, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517071, max_value=1.520442, exclude_min=True, allow_nan=False),
           st.sampled_from([13.79, 14.0, 14.09, 14.15, 14.4, 14.46, 14.56, 14.99, 17.38]),
           st.floats(min_value=2.088, max_value=2.609, allow_nan=False),
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
           st.sampled_from([72.37, 72.38, 72.5, 72.67, 72.74, 72.76, 73.48, 74.55, 75.41]),
           st.sampled_from([0.0]),
           st.floats(min_value=9.47, max_value=10.479, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.floats(min_value=0.091, max_value=0.113, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.517071, max_value=1.518271, exclude_min=True, allow_nan=False),
           st.sampled_from([12.61, 12.84, 13.02, 13.39, 13.49, 13.51, 13.58, 13.64, 13.81, 14.04]),
           st.floats(min_value=2.612, max_value=2.816, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
    ...
    @given(st.floats(min_value=1.523076, max_value=1.525246, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517071, max_value=1.517233, exclude_min=True, allow_nan=False),
           st.sampled_from([12.74, 12.86, 13.0, 13.39, 13.51, 13.58, 13.72, 13.81, 13.99, 14.21]),
           st.floats(min_value=3.636, max_value=3.681, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
           ...
           st.floats(min_value=7.918, max_value=8.539, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.floats(min_value=0.091, max_value=0.113, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.517887, max_value=1.521095, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517071, max_value=1.517219, exclude_min=True, allow_nan=False),
           st.sampled_from([12.16, 13.04, 13.14, 13.24, 13.33, 13.42, 13.5, 13.53, 13.65, 14.19]),
           st.floats(min_value=3.636, max_value=3.681, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.009, max_value=1.188, allow_nan=False),
           ...
           st.floats(min_value=8.542, max_value=8.929, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.floats(min_value=0.091, max_value=0.113, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.517071, max_value=1.517219, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.636, max_value=3.681, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.191, max_value=1.236, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517816, max_value=1.521038, exclude_min=True, allow_nan=False),
           st.floats(min_value=13.441, max_value=14.118, allow_nan=False),
           st.floats(min_value=3.636, max_value=3.681, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.573, max_value=0.643, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517816, max_value=1.521038, exclude_min=True, allow_nan=False),
           st.floats(min_value=14.121, max_value=14.772, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.636, max_value=3.681, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.573, max_value=0.643, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517816, max_value=1.521038, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.636, max_value=3.681, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.646, max_value=0.8, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517071, max_value=1.520442, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.882, max_value=13.419, allow_nan=False),
           st.floats(min_value=3.091, max_value=3.863, allow_nan=False),
           st.floats(min_value=0.993, max_value=1.168, allow_nan=False),
           ...
           st.floats(min_value=8.781, max_value=9.618, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.floats(min_value=0.116, max_value=0.194, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.517071, max_value=1.520442, exclude_min=True, allow_nan=False),
           st.floats(min_value=13.422, max_value=14.213, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.091, max_value=3.863, allow_nan=False),
           st.floats(min_value=0.993, max_value=1.168, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517071, max_value=1.520442, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=2.892, max_value=3.614, allow_nan=False),
           st.floats(min_value=1.171, max_value=1.22, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517071, max_value=1.520442, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.617, max_value=3.666, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.171, max_value=1.22, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517071, max_value=1.520442, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=9.621, max_value=9.792, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.floats(min_value=0.116, max_value=0.194, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.517071, max_value=1.520442, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.866, max_value=3.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
           ...
           st.floats(min_value=7.961, max_value=8.593, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517071, max_value=1.520442, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.866, max_value=3.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.83, max_value=0.964, allow_nan=False),
           ...
           st.floats(min_value=8.596, max_value=8.972, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.sampled_from([0.0, 0.09, 0.1, 0.17, 0.24, 0.37]))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.517071, max_value=1.520442, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.866, max_value=3.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.967, max_value=1.057, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.51593, 1.51596, 1.51605, 1.51645, 1.51687, 1.51707, 1.51708, 1.51829, 1.51847, 1.52222]),
           st.floats(min_value=13.742, max_value=14.494, allow_nan=False),
           st.sampled_from([1.35, 2.88, 3.09, 3.55, 3.58, 3.61, 3.63, 3.64, 3.9, 3.98]),
           st.floats(min_value=1.161, max_value=1.378, allow_nan=False),
           ...
           st.floats(min_value=10.482, max_value=11.623, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
    ...
    @given(st.sampled_from([1.51316, 1.51321, 1.51666, 1.51969, 1.51994, 1.52043, 1.52058, 1.52119, 1.52151, 1.52171]),
           ...
           st.floats(min_value=1.381, max_value=1.388, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.51115, 1.51299, 1.51829, 1.51852, 1.51888, 1.51905, 1.51916, 1.51937, 1.51969]),
           st.floats(min_value=14.497, max_value=15.073, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 0.78, 1.74, 2.19, 2.24, 2.39, 2.41]),
           st.floats(min_value=1.193, max_value=1.418, allow_nan=False),
           st.sampled_from([72.37, 72.38, 72.5, 72.67, 72.74, 72.76, 73.48, 74.55, 75.41]),
           st.sampled_from([0.0]),
    ...
    @given(st.floats(min_value=1.521605, max_value=1.524218, allow_nan=False),
           st.floats(min_value=12.941, max_value=13.493, allow_nan=False),
           st.floats(min_value=1.807, max_value=2.258, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.524221, max_value=1.526162, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.941, max_value=13.493, allow_nan=False),
           st.floats(min_value=1.807, max_value=2.258, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.51115, 1.51299, 1.51829, 1.51852, 1.51888, 1.51905, 1.51916, 1.51937, 1.51969]),
           st.floats(min_value=13.496, max_value=14.272, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.807, max_value=2.258, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
           st.sampled_from([72.37, 72.38, 72.5, 72.67, 72.74, 72.76, 73.48, 74.55, 75.41]),
           st.floats(min_value=0.155, max_value=0.193, allow_nan=False),
    ...
    @given(st.floats(min_value=1.519489, max_value=1.521573, allow_nan=False),
           st.floats(min_value=13.496, max_value=14.272, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.807, max_value=2.258, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
           st.sampled_from([72.06, 72.26, 72.38, 72.39, 72.67, 72.96, 72.97, 73.07, 73.14, 73.21]),
           st.floats(min_value=0.196, max_value=1.398, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.521576, max_value=1.524046, exclude_min=True, allow_nan=False),
           st.floats(min_value=13.496, max_value=14.272, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.807, max_value=2.258, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.514998, max_value=1.515959, allow_nan=False),
           st.sampled_from([10.73, 13.23, 13.3, 13.41, 13.44, 13.46, 13.7, 13.72, 13.78, 14.43]),
           st.floats(min_value=2.261, max_value=2.706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=7.33, max_value=7.804, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.floats(min_value=0.183, max_value=0.228, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.515962, max_value=1.516234, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.516089, max_value=1.517323, allow_nan=False),
           st.sampled_from([12.55, 12.75, 12.79, 12.87, 12.89, 12.94, 13.12, 13.2, 13.43, 13.75]),
           st.floats(min_value=2.261, max_value=2.706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
           st.floats(min_value=71.962, max_value=72.499, allow_nan=False),
           st.sampled_from([0.06, 0.1, 0.33, 0.35, 0.57, 0.6, 0.61, 0.7, 0.81, 1.1]),
           st.floats(min_value=7.807, max_value=7.886, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.floats(min_value=0.183, max_value=0.228, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.516089, max_value=1.517323, allow_nan=False),
           ...
           st.floats(min_value=8.206, max_value=9.802, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.floats(min_value=0.183, max_value=0.228, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.516089, max_value=1.517323, allow_nan=False),
           ...
           st.floats(min_value=2.261, max_value=2.706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
           st.floats(min_value=72.501, max_value=73.082, exclude_min=True, allow_nan=False),
           st.sampled_from([0.08, 0.33, 0.38, 0.44, 0.6, 0.63, 0.64, 0.72, 0.73, 1.1]),
           st.floats(min_value=7.807, max_value=9.483, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.floats(min_value=0.183, max_value=0.228, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.516089, max_value=1.517323, allow_nan=False),
           st.floats(min_value=12.402, max_value=12.819, allow_nan=False),
           st.floats(min_value=2.261, max_value=2.706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.floats(min_value=0.231, max_value=0.286, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.516089, max_value=1.517323, allow_nan=False),
           st.floats(min_value=12.822, max_value=13.733, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.261, max_value=2.706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517326, max_value=1.517404, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517722, max_value=1.517773, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517981, max_value=1.52117, exclude_min=True, allow_nan=False),
           st.floats(min_value=13.257, max_value=13.888, allow_nan=False),
           st.floats(min_value=2.261, max_value=2.706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=8.197, max_value=8.888, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517981, max_value=1.52117, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=8.891, max_value=8.996, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
           st.sampled_from([0.0, 0.09, 0.1, 0.17, 0.24, 0.37]))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.517981, max_value=1.52117, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=9.422, max_value=10.775, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.268, max_value=0.334, allow_nan=False),
    ...
    @given(st.floats(min_value=1.517981, max_value=1.52117, exclude_min=True, allow_nan=False),
           st.floats(min_value=13.891, max_value=14.588, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.261, max_value=2.706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.421, max_value=1.836, exclude_min=True, allow_nan=False),
           st.sampled_from([72.37, 72.38, 72.5, 72.67, 72.74, 72.76, 73.48, 74.55, 75.41]),
           st.sampled_from([0.0]),
    ...
    @given(st.sampled_from([1.51594, 1.51596, 1.51629, 1.5166, 1.51663, 1.51707, 1.51851, 1.51872, 1.52068, 1.53125]),
           ...
           st.floats(min_value=1.072, max_value=1.339, allow_nan=False),
           st.sampled_from([0.56, 1.06, 1.08, 1.17, 1.25, 1.3, 1.48, 1.54, 1.58, 1.67]),
           st.floats(min_value=70.089, max_value=70.158, allow_nan=False),
           ...
           st.floats(min_value=0.337, max_value=0.899, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.51316, 1.51321, 1.51514, 1.51666, 1.51915, 1.51969, 1.52058, 1.52119, 1.52151, 1.52369]),
           ...
           st.floats(min_value=1.342, max_value=1.971, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.51514, 1.51545, 1.51602, 1.51623, 1.5164, 1.51645, 1.51711, 1.51831, 1.51838, 1.52065]),
           ...
           st.floats(min_value=2.735, max_value=3.418, allow_nan=False),
           st.sampled_from([1.23, 1.31, 1.8, 1.87, 2.02, 2.06, 2.34, 2.42, 2.51, 2.54]),
           st.floats(min_value=70.161, max_value=71.21, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.51743, 1.51756, 1.51768, 1.51769, 1.51775, 1.51783, 1.51837, 1.51909, 1.51911, 1.51926]),
           ...
           st.floats(min_value=3.421, max_value=3.634, exclude_min=True, allow_nan=False),
