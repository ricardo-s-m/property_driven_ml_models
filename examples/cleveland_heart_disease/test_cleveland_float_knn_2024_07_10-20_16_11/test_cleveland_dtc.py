...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_cleveland_dtc_experiment_data.json')
...
class TestClevelandProperty:
    ...
    @given(st.floats(min_value=29.0, max_value=59.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0, 4.0]),
           st.floats(min_value=94.0, max_value=108.99, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.0, max_value=1.68, allow_nan=False),
    ...
    @given(st.floats(min_value=29.0, max_value=59.49, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.0, max_value=0.59, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=29.0, max_value=59.49, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.62, max_value=1.68, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=29.0, max_value=59.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([1.0, 2.0, 3.0, 4.0]),
           st.floats(min_value=109.01, max_value=156.99, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=29.0, max_value=59.49, allow_nan=False),
           ...
           st.floats(min_value=94.0, max_value=156.99, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=1.71, max_value=3.53, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=29.0, max_value=59.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=2.51, max_value=4.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=94.0, max_value=156.99, allow_nan=False),
    ...
    @given(st.floats(min_value=29.0, max_value=59.49, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=3.56, max_value=6.2, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=59.51, max_value=77.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([1.0, 2.0, 3.0, 4.0]),
           st.floats(min_value=94.0, max_value=156.99, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=71.0, max_value=83.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.floats(min_value=59.51, max_value=77.0, exclude_min=True, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=83.51, max_value=152.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
    ...
    @given(st.floats(min_value=59.51, max_value=77.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=83.51, max_value=152.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=1.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=6.2, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=59.51, max_value=77.0, exclude_min=True, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=152.51, max_value=155.99, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.floats(min_value=59.51, max_value=77.0, exclude_min=True, allow_nan=False),
           ...
           st.sampled_from([1.0, 2.0, 3.0, 4.0]),
           st.floats(min_value=94.0, max_value=156.99, allow_nan=False),
           st.floats(min_value=126.0, max_value=290.99, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=156.01, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.floats(min_value=59.51, max_value=77.0, exclude_min=True, allow_nan=False),
           ...
           st.sampled_from([1.0, 2.0, 3.0, 4.0]),
           st.floats(min_value=94.0, max_value=156.99, allow_nan=False),
           st.floats(min_value=291.01, max_value=564.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=156.01, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.floats(min_value=59.51, max_value=77.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.51, max_value=3.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=29.0, max_value=61.99, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([1.0, 2.0, 3.0, 4.0]),
           st.floats(min_value=157.01, max_value=200.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=62.01, max_value=77.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([1.0, 2.0, 3.0, 4.0]),
           st.floats(min_value=157.01, max_value=200.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([39.0, 41.0, 47.0, 52.0, 54.0, 55.0, 58.0, 63.0, 65.0, 69.0]),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           st.sampled_from([100.0, 112.0, 122.0, 123.0, 130.0, 135.0, 138.0, 144.0, 150.0, 174.0]),
           st.floats(min_value=126.0, max_value=202.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=71.0, max_value=141.99, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.1, 0.3, 1.2, 1.6, 1.9, 2.2, 2.8, 2.9, 4.0, 4.2]),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.51, max_value=3.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([34.0, 45.0, 49.0, 52.0, 56.0, 59.0, 60.0, 61.0, 62.0, 66.0]),
           ...
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=142.01, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.sampled_from([34.0, 35.0, 43.0, 44.0, 47.0, 50.0, 56.0, 67.0, 71.0, 74.0]),
           ...
           st.floats(min_value=202.51, max_value=237.49, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=71.0, max_value=137.99, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.sampled_from([35.0, 40.0, 48.0, 50.0, 52.0, 57.0, 58.0, 63.0, 68.0, 69.0]),
           ...
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=138.01, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.sampled_from([29.0, 40.0, 47.0, 48.0, 50.0, 52.0, 58.0, 68.0, 70.0, 76.0]),
           ...
           st.floats(min_value=237.51, max_value=564.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.sampled_from([0.0, 1.0, 2.0]),
    ...
    @given(st.sampled_from([29.0, 40.0, 42.0, 51.0, 55.0, 56.0, 60.0, 62.0, 64.0, 71.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=3.51, max_value=4.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([39.0, 45.0, 46.0, 49.0, 50.0, 61.0, 62.0, 64.0, 68.0, 70.0]),
           ...
           st.floats(min_value=126.0, max_value=298.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
    ...
    @given(st.sampled_from([29.0, 39.0, 41.0, 44.0, 50.0, 60.0, 61.0, 64.0, 68.0, 69.0]),
           ...
           st.floats(min_value=298.51, max_value=564.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
    ...
    @given(st.sampled_from([35.0, 41.0, 43.0, 54.0, 58.0, 63.0, 64.0, 68.0, 71.0, 76.0]),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.0, max_value=0.09, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([38.0, 41.0, 46.0, 51.0, 57.0, 59.0, 63.0, 67.0, 69.0, 70.0]),
           ...
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=71.0, max_value=132.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.12, max_value=6.2, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=29.0, max_value=38.99, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           st.floats(min_value=94.0, max_value=178.99, allow_nan=False),
           st.sampled_from([174.0, 187.0, 225.0, 248.0, 249.0, 253.0, 256.0, 284.0, 309.0, 322.0]),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=132.51, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.12, max_value=6.2, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
    ...
    @given(st.floats(min_value=39.01, max_value=77.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           st.floats(min_value=94.0, max_value=178.99, allow_nan=False),
           ...
           st.floats(min_value=132.51, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.12, max_value=0.34, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=39.01, max_value=77.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.0, max_value=1.49, allow_nan=False),
           st.floats(min_value=94.0, max_value=178.99, allow_nan=False),
           st.floats(min_value=126.0, max_value=230.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=132.51, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.37, max_value=6.2, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=39.01, max_value=77.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=1.51, max_value=3.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=94.0, max_value=178.99, allow_nan=False),
           st.floats(min_value=126.0, max_value=205.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=132.51, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.floats(min_value=39.01, max_value=77.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.51, max_value=3.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=94.0, max_value=178.99, allow_nan=False),
           st.floats(min_value=205.51, max_value=230.49, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=132.51, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.floats(min_value=39.01, max_value=77.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           st.floats(min_value=94.0, max_value=178.99, allow_nan=False),
           st.floats(min_value=230.51, max_value=564.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=132.51, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.sampled_from([40.0, 41.0, 42.0, 48.0, 60.0, 62.0, 64.0, 66.0, 70.0, 77.0]),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           st.floats(min_value=179.01, max_value=200.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([35.0, 38.0, 39.0, 43.0, 46.0, 49.0, 51.0, 56.0, 70.0, 77.0]),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=1.01, max_value=2.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([42.0, 44.0, 46.0, 47.0, 60.0, 62.0, 64.0, 67.0, 70.0, 77.0]),
           ...
           st.floats(min_value=1.51, max_value=3.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=1.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([39.0, 43.0, 51.0, 55.0, 57.0, 61.0, 62.0, 66.0, 69.0, 77.0]),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           st.floats(min_value=94.0, max_value=124.99, allow_nan=False),
           ...
           st.floats(min_value=1.51, max_value=3.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.01, max_value=3.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([40.0, 43.0, 44.0, 54.0, 56.0, 57.0, 60.0, 68.0, 69.0, 76.0]),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           st.floats(min_value=125.01, max_value=134.99, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([38.0, 46.0, 47.0, 48.0, 50.0, 51.0, 58.0, 60.0, 69.0, 70.0]),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           st.floats(min_value=135.01, max_value=200.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([34.0, 37.0, 40.0, 47.0, 49.0, 51.0, 57.0, 61.0, 62.0, 63.0]),
           ...
           st.floats(min_value=126.0, max_value=236.99, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=71.0, max_value=148.99, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.0, max_value=0.54, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
    ...
    @given(st.floats(min_value=29.0, max_value=60.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=3.51, max_value=4.0, exclude_min=True, allow_nan=False),
           st.sampled_from([100.0, 112.0, 122.0, 125.0, 132.0, 134.0, 140.0, 154.0, 164.0, 165.0]),
           st.floats(min_value=237.01, max_value=564.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=71.0, max_value=148.99, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.floats(min_value=60.51, max_value=77.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=3.51, max_value=4.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=29.0, max_value=41.99, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=3.51, max_value=4.0, exclude_min=True, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=149.01, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.0, max_value=0.54, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False),
    ...
    @given(st.floats(min_value=42.01, max_value=77.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=3.51, max_value=4.0, exclude_min=True, allow_nan=False),
           st.sampled_from([100.0, 105.0, 112.0, 118.0, 122.0, 126.0, 135.0, 150.0, 160.0, 172.0]),
           st.floats(min_value=126.0, max_value=253.99, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=149.01, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.floats(min_value=42.01, max_value=77.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=254.01, max_value=564.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.floats(min_value=149.01, max_value=202.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
    ...
    @given(st.floats(min_value=29.0, max_value=65.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=3.51, max_value=4.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=94.0, max_value=111.99, allow_nan=False),
           st.floats(min_value=126.0, max_value=224.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
           st.sampled_from([114.0, 121.0, 142.0, 145.0, 154.0, 171.0, 172.0, 174.0, 180.0, 181.0]),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=0.57, max_value=6.2, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0, 3.0]),
           st.sampled_from([0.0, 1.0, 2.0, 3.0]),
    ...
    @given(st.floats(min_value=29.0, max_value=65.49, allow_nan=False),
           ...
           st.floats(min_value=3.51, max_value=4.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=94.0, max_value=111.99, allow_nan=False),
           st.floats(min_value=224.51, max_value=564.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0, 1.0, 2.0]),
    ...
    @given(st.floats(min_value=29.0, max_value=65.49, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=3.51, max_value=4.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=112.01, max_value=200.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=65.51, max_value=77.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=3.51, max_value=4.0, exclude_min=True, allow_nan=False),
