...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_haberman_survival_dtc_experiment_data.json')
...
class TestHabermanSurvivalProperty:
    ...
    @given(st.floats(min_value=30.0, max_value=32.49, allow_nan=False),
           st.floats(min_value=58.0, max_value=59.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    ...
    @given(st.floats(min_value=32.51, max_value=34.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=59.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=30.0, max_value=34.49, allow_nan=False),
           st.floats(min_value=59.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=34.51, max_value=40.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=65.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=30.0, max_value=38.49, allow_nan=False),
           st.floats(min_value=65.51, max_value=66.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=38.51, max_value=40.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=65.51, max_value=66.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=30.0, max_value=40.49, allow_nan=False),
           st.floats(min_value=66.51, max_value=69.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=40.51, max_value=42.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=58.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=40.51, max_value=41.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=59.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=41.51, max_value=42.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=59.49, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=41.51, max_value=42.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=59.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.01, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=42.51, max_value=47.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=59.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=40.51, max_value=46.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=59.51, max_value=63.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=46.51, max_value=47.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=59.51, max_value=61.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=46.51, max_value=47.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=61.51, max_value=63.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=40.51, max_value=41.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=63.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.99, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=42.01, max_value=43.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=63.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.99, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=44.01, max_value=47.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=63.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.99, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=40.51, max_value=47.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=63.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.01, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=40.51, max_value=43.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=64.51, max_value=65.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=40.51, max_value=43.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=66.01, max_value=67.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=44.01, max_value=47.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=64.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=44.01, max_value=45.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=65.51, max_value=66.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=44.01, max_value=45.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=66.51, max_value=67.49, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=44.01, max_value=45.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=66.51, max_value=67.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=46.01, max_value=47.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=65.51, max_value=67.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=40.51, max_value=47.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=67.51, max_value=68.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=40.51, max_value=47.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=68.51, max_value=69.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=47.51, max_value=59.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=62.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=1.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=47.51, max_value=50.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=59.49, allow_nan=False),
           st.floats(min_value=1.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=51.01, max_value=59.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=59.49, allow_nan=False),
           st.floats(min_value=1.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=47.51, max_value=59.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=59.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=47.51, max_value=48.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=62.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=48.51, max_value=50.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=62.51, max_value=63.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=48.51, max_value=50.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=63.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=50.51, max_value=59.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=62.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=47.51, max_value=51.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=62.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=51.51, max_value=57.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=62.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=58.01, max_value=59.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=62.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=59.51, max_value=62.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=58.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=63.01, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=58.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=64.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=58.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=65.51, max_value=67.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=58.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=59.51, max_value=67.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=58.49, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=68.01, max_value=70.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=58.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=71.01, max_value=77.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=58.49, allow_nan=False),
           st.floats(min_value=0.0, max_value=2.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=59.51, max_value=70.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=71.01, max_value=72.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=63.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=72.51, max_value=77.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=59.51, max_value=63.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=64.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=64.01, max_value=77.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=64.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=59.51, max_value=61.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=61.51, max_value=77.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=59.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=61.51, max_value=70.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=59.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=2.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=47.51, max_value=77.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=65.51, max_value=69.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=47.51, max_value=77.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=67.51, max_value=69.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.51, max_value=1.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=30.0, max_value=50.49, allow_nan=False),
           st.floats(min_value=58.0, max_value=68.49, allow_nan=False),
           st.floats(min_value=2.51, max_value=4.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=50.51, max_value=53.49, exclude_min=True, allow_nan=False),
           st.sampled_from([58.0, 59.0, 61.0, 62.0, 63.0, 64.0, 66.0, 67.0, 68.0, 69.0]),
           st.floats(min_value=2.51, max_value=3.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=50.51, max_value=53.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=58.99, allow_nan=False),
           st.floats(min_value=3.51, max_value=4.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=50.51, max_value=53.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=59.01, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.51, max_value=4.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=50.51, max_value=53.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=64.51, max_value=69.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.51, max_value=4.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=53.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=64.99, allow_nan=False),
           st.floats(min_value=2.51, max_value=4.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=53.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=65.01, max_value=66.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.51, max_value=4.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=64.51, max_value=72.99, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=73.01, max_value=75.49, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=75.51, max_value=77.49, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=64.51, max_value=77.49, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=77.51, max_value=83.0, exclude_min=True, allow_nan=False),
           st.sampled_from([58.0, 59.0, 60.0, 62.0, 63.0, 64.0, 65.0, 67.0, 68.0, 69.0]),
           st.floats(min_value=0.0, max_value=4.49, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=30.0, max_value=34.49, allow_nan=False),
           st.floats(min_value=58.0, max_value=66.49, allow_nan=False),
           st.floats(min_value=4.51, max_value=9.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=30.0, max_value=34.49, allow_nan=False),
           ...
           st.floats(min_value=9.51, max_value=20.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=34.51, max_value=42.49, exclude_min=True, allow_nan=False),
           st.sampled_from([58.0, 60.0, 61.0, 62.0, 63.0, 65.0, 66.0, 67.0, 68.0, 69.0]),
           st.floats(min_value=4.51, max_value=20.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=30.0, max_value=42.49, allow_nan=False),
           st.sampled_from([58.0, 59.0, 60.0, 62.0, 63.0, 64.0, 65.0, 67.0, 68.0, 69.0]),
           st.floats(min_value=20.51, max_value=26.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=30.0, max_value=42.49, allow_nan=False),
           ...
           st.floats(min_value=26.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=42.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=58.49, allow_nan=False),
           st.floats(min_value=4.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=42.51, max_value=43.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=68.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=43.51, max_value=46.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=68.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.51, max_value=8.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=46.51, max_value=52.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=65.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.51, max_value=5.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=53.01, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=65.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.51, max_value=5.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=46.51, max_value=54.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=65.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.51, max_value=8.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=54.51, max_value=56.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=65.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.51, max_value=8.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=57.01, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=65.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.51, max_value=8.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=46.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=66.01, max_value=68.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.51, max_value=8.49, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=43.51, max_value=47.99, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=59.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=48.01, max_value=53.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=59.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=43.51, max_value=53.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=59.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=53.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.51, max_value=20.99, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=53.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=21.01, max_value=29.99, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=53.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=30.01, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=53.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=62.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=43.51, max_value=62.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=64.51, max_value=65.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=62.51, max_value=64.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=68.49, allow_nan=False),
           st.floats(min_value=4.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=64.51, max_value=69.49, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=68.49, allow_nan=False),
           st.floats(min_value=4.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=69.51, max_value=83.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.0, max_value=68.49, allow_nan=False),
           st.floats(min_value=4.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=42.51, max_value=83.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=68.51, max_value=69.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.51, max_value=52.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
