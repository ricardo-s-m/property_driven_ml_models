...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_blood_transfusion_dtc_experiment_data.json')
...
class TestBloodTransfusionProperty:
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=1.4, allow_nan=False),
           st.floats(min_value=250, max_value=1124.9, allow_nan=False),
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=250, max_value=1124.9, allow_nan=False),
           st.floats(min_value=2, max_value=2.4, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           ...
           st.floats(min_value=250, max_value=1124.9, allow_nan=False),
           st.floats(min_value=2.6, max_value=3.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           ...
           st.floats(min_value=250, max_value=374.9, allow_nan=False),
           st.floats(min_value=3.6, max_value=16.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=0.9, allow_nan=False),
           st.sampled_from([1, 6, 8, 9, 12, 14, 15, 18, 23, 38]),
           st.floats(min_value=375.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.6, max_value=11.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.1, max_value=2.9, exclude_min=True, allow_nan=False),
           st.sampled_from([2, 3, 4, 5, 7, 9, 11, 13, 14, 38]),
           st.floats(min_value=375.1, max_value=624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.6, max_value=6.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=4.9, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.1, max_value=2.9, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=375.1, max_value=624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.6, max_value=10.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.1, max_value=4.9, exclude_min=True, allow_nan=False),
           st.sampled_from([3, 6, 7, 8, 9, 12, 17, 18, 19, 44]),
           st.floats(min_value=375.1, max_value=624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=10.6, max_value=11.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.1, max_value=4.9, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=625.1, max_value=874.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.6, max_value=9.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.1, max_value=4.9, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=875.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.6, max_value=9.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.1, max_value=4.9, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=625.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=10.1, max_value=11.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=5.1, max_value=6.4, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=2.4, allow_nan=False),
           st.floats(min_value=375.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.1, max_value=16.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=4.9, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=375.1, max_value=874.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.1, max_value=14.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=875.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.1, max_value=14.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=375.1, max_value=874.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=15.1, max_value=16.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           ...
           st.floats(min_value=250, max_value=1124.9, allow_nan=False),
           st.floats(min_value=17.1, max_value=24.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           ...
           st.floats(min_value=250, max_value=1124.9, allow_nan=False),
           st.floats(min_value=24.6, max_value=25.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=2.4, allow_nan=False),
           st.floats(min_value=250, max_value=1124.9, allow_nan=False),
           st.floats(min_value=25.6, max_value=48.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=2.4, allow_nan=False),
           st.floats(min_value=250, max_value=1124.9, allow_nan=False),
           st.floats(min_value=48.6, max_value=51.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=2.4, allow_nan=False),
           st.floats(min_value=250, max_value=1124.9, allow_nan=False),
           st.floats(min_value=51.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.4, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=250, max_value=874.9, allow_nan=False),
           st.floats(min_value=25.6, max_value=36.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.4, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=250, max_value=874.9, allow_nan=False),
           st.floats(min_value=36.6, max_value=44.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.4, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=250, max_value=874.9, allow_nan=False),
           st.floats(min_value=45.1, max_value=63.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.4, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=250, max_value=874.9, allow_nan=False),
           st.floats(min_value=63.6, max_value=75.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.4, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=250, max_value=874.9, allow_nan=False),
           st.floats(min_value=76.1, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.4, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=875.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=25.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=2.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=250, max_value=874.9, allow_nan=False),
           st.floats(min_value=25.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=2.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=875.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=25.6, max_value=27.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=2.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=875.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=27.6, max_value=37.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=2.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=875.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=37.6, max_value=41.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=2.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=875.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=42.1, max_value=44.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=2.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=875.1, max_value=1124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=44.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=2, max_value=12.9, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=5.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=13.1, max_value=14.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=5.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1125.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=13.1, max_value=14.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1125.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=13.1, max_value=14.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=14.6, max_value=18.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=14.6, max_value=18.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.6, max_value=21.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=3.4, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=21.6, max_value=29.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=3.4, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=29.6, max_value=33.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=3.4, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=33.6, max_value=39.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=21.6, max_value=24.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=24.6, max_value=26.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=27.1, max_value=30.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=30.6, max_value=33.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=33.6, max_value=34.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=34.6, max_value=39.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=21.6, max_value=23.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=24.1, max_value=26.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=27.1, max_value=28.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=21.6, max_value=28.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=29.1, max_value=36.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=29.1, max_value=32.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=32.6, max_value=36.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=4.4, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=36.6, max_value=38.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=4.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=21.6, max_value=38.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1375.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=38.6, max_value=39.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=40.1, max_value=41.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=1, max_value=14.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=1374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=42.1, max_value=49.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=1625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.6, max_value=21.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=1625.1, max_value=2124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=21.6, max_value=28.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=1625.1, max_value=2124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=21.6, max_value=23.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=1625.1, max_value=2124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=23.6, max_value=25.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=1625.1, max_value=2124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=25.6, max_value=26.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=1625.1, max_value=2124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=27.1, max_value=28.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=1625.1, max_value=2124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=28.6, max_value=30.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=1625.1, max_value=2124.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=30.6, max_value=48.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=2125.1, max_value=2374.9, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=2125.1, max_value=2374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=27.1, max_value=38.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=2125.1, max_value=2374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=27.1, max_value=32.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.1, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=2125.1, max_value=2374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=33.1, max_value=38.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=2125.1, max_value=2374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=39.1, max_value=48.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=2375.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=21.6, max_value=48.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=10.4, allow_nan=False),
           st.floats(min_value=1625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=48.6, max_value=49.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=0.9, allow_nan=False),
           st.floats(min_value=10.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.6, max_value=29.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.1, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=10.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.6, max_value=29.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=1.4, allow_nan=False),
           st.floats(min_value=10.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=30.1, max_value=49.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=10.6, max_value=13.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=30.1, max_value=43.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=10.6, max_value=13.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=43.6, max_value=46.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=10.6, max_value=13.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=46.6, max_value=49.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.6, max_value=2.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=13.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=30.1, max_value=49.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=14.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=1125.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=2, max_value=49.4, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.4, allow_nan=False),
           st.floats(min_value=1, max_value=12.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=2624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=49.6, max_value=57.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.4, allow_nan=False),
           st.floats(min_value=1, max_value=12.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=2624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=57.6, max_value=58.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.4, allow_nan=False),
           st.floats(min_value=1, max_value=12.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=2624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=58.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=2.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=12.4, allow_nan=False),
           st.floats(min_value=1125.1, max_value=2624.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=49.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=12.4, allow_nan=False),
           st.floats(min_value=2625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=49.6, max_value=62.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=12.4, allow_nan=False),
           st.floats(min_value=2625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=62.6, max_value=72.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=2.9, allow_nan=False),
           st.floats(min_value=1, max_value=12.4, allow_nan=False),
           st.floats(min_value=2625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=72.6, max_value=80.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=1, max_value=12.4, allow_nan=False),
           st.floats(min_value=2625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=80.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=12.6, max_value=24.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=1125.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=49.6, max_value=57.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=3.4, allow_nan=False),
           st.floats(min_value=12.6, max_value=24.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=1125.1, max_value=3374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=57.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=3.4, allow_nan=False),
           st.floats(min_value=12.6, max_value=24.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=3375.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=57.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.6, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.6, max_value=24.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=1125.1, max_value=3749.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=57.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.6, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.6, max_value=21.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=3750.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=57.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=25.1, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=1125.1, max_value=10874.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=49.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=25.1, max_value=44.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=10875.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=49.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0, max_value=6.4, allow_nan=False),
           st.floats(min_value=45.1, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=10875.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=49.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=1.4, allow_nan=False),
           st.sampled_from([750, 1000, 1500, 1750, 2750, 3000, 3750, 4750, 5750, 9500]),
           st.floats(min_value=2, max_value=9.9, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=10.1, max_value=12.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.6, max_value=2.4, exclude_min=True, allow_nan=False),
           st.sampled_from([250, 500, 750, 1000, 1250, 2250, 2500, 2750, 4750, 9500]),
           st.floats(min_value=2, max_value=12.4, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=2.4, allow_nan=False),
           st.floats(min_value=250, max_value=374.9, allow_nan=False),
           st.floats(min_value=12.6, max_value=15.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=12.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=2.4, allow_nan=False),
           st.floats(min_value=375.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.6, max_value=15.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=12.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=2.4, allow_nan=False),
           st.floats(min_value=375.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.6, max_value=15.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=11.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
           st.sampled_from([500, 1000, 1250, 2500, 3250, 4000, 4250, 4500, 5750, 6000]),
           st.floats(min_value=2, max_value=15.4, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=12.1, max_value=13.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=13.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.6, max_value=50, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=6.6, max_value=8.4, exclude_min=True, allow_nan=False),
           st.sampled_from([1, 2, 3, 8, 11, 18, 19, 22, 23, 44]),
           st.sampled_from([250, 500, 2500, 3250, 4000, 4250, 4500, 5500, 5750, 11000]),
           st.floats(min_value=15.6, max_value=16.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=8.6, max_value=9.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=6.4, allow_nan=False),
    ...
    @given(st.floats(min_value=9.6, max_value=11.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=6.4, allow_nan=False),
           st.floats(min_value=250, max_value=624.9, allow_nan=False),
           st.floats(min_value=15.6, max_value=16.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=9.6, max_value=10.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=6.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=15.6, max_value=16.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=10.6, max_value=11.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=6.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=15.6, max_value=16.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=8.6, max_value=11.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.6, max_value=50, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=6.6, max_value=13.4, exclude_min=True, allow_nan=False),
           st.sampled_from([1, 2, 3, 4, 8, 15, 17, 18, 24, 44]),
           st.sampled_from([250, 500, 1250, 1750, 2000, 3500, 3750, 4500, 4750, 5750]),
           st.floats(min_value=16.6, max_value=23.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=13.6, max_value=14.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=15.6, max_value=17.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=13.6, max_value=14.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=250, max_value=874.9, allow_nan=False),
           st.floats(min_value=17.6, max_value=19.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=13.6, max_value=14.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=250, max_value=624.9, allow_nan=False),
           st.floats(min_value=20.1, max_value=23.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=13.6, max_value=14.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=875.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=17.6, max_value=23.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.sampled_from([750, 1000, 2250, 3000, 3250, 3500, 3750, 4000, 4250, 5500]),
           st.floats(min_value=23.6, max_value=27.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=250, max_value=624.9, allow_nan=False),
           st.floats(min_value=27.6, max_value=31.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=250, max_value=624.9, allow_nan=False),
           st.floats(min_value=32.1, max_value=36.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=250, max_value=624.9, allow_nan=False),
           st.floats(min_value=36.6, max_value=51.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=28.6, max_value=35.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=12.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=999.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=36.1, max_value=37.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=12.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=1000.1, max_value=1499.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=36.1, max_value=37.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=12.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=1500.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=36.1, max_value=37.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=12.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=37.6, max_value=38.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=12.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=39.1, max_value=40.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=12.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=36.1, max_value=40.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=40.6, max_value=50.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=11.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=50.6, max_value=51.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=11.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=7.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=50.6, max_value=51.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=51.6, max_value=61.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=61.6, max_value=62.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=63.1, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=9.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.6, max_value=8.4, exclude_min=True, allow_nan=False),
           st.sampled_from([250, 2500, 3000, 3250, 4000, 4250, 5000, 5250, 6500, 10750]),
           st.floats(min_value=23.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=9.6, max_value=10.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=23.6, max_value=43.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=9.6, max_value=11.9, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=43.6, max_value=48.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=12.1, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.6, max_value=8.4, exclude_min=True, allow_nan=False),
           st.sampled_from([250, 1750, 2500, 3250, 3750, 4000, 4750, 5500, 5750, 11000]),
           st.floats(min_value=23.6, max_value=48.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=9.6, max_value=12.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.6, max_value=8.4, exclude_min=True, allow_nan=False),
           st.sampled_from([250, 2000, 2250, 2750, 3500, 3750, 4000, 4750, 5000, 11500]),
           st.floats(min_value=49.1, max_value=61.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=9.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.6, max_value=8.4, exclude_min=True, allow_nan=False),
           st.sampled_from([750, 1000, 2000, 2250, 2500, 3000, 4250, 4500, 4750, 5750]),
           st.floats(min_value=62.1, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=9.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.6, max_value=10.4, exclude_min=True, allow_nan=False),
           st.sampled_from([1750, 2250, 2500, 3000, 3500, 3750, 4500, 5500, 6000, 9500]),
           st.floats(min_value=23.6, max_value=71.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=7.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=10.6, max_value=50, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=8.1, max_value=9.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=10.6, max_value=50, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=10.1, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.6, max_value=50, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=71.6, max_value=74.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=250, max_value=2499.9, allow_nan=False),
           st.floats(min_value=75.1, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.6, max_value=16.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2500.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=75.1, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=16.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=2500.1, max_value=4374.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=75.1, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.6, max_value=14.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=16.6, max_value=50, exclude_min=True, allow_nan=False),
           st.floats(min_value=4375.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=75.1, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=19.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=4.4, allow_nan=False),
           st.floats(min_value=250, max_value=624.9, allow_nan=False),
           st.floats(min_value=2, max_value=26.4, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=19.6, max_value=74, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=1.4, allow_nan=False),
           st.floats(min_value=250, max_value=624.9, allow_nan=False),
           st.floats(min_value=2, max_value=21.4, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=19.6, max_value=74, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.6, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=250, max_value=624.9, allow_nan=False),
           st.floats(min_value=2, max_value=21.4, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=19.6, max_value=74, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=4.4, allow_nan=False),
           st.floats(min_value=250, max_value=624.9, allow_nan=False),
           st.floats(min_value=21.6, max_value=22.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=19.6, max_value=74, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=4.4, allow_nan=False),
           st.floats(min_value=250, max_value=374.9, allow_nan=False),
           st.floats(min_value=22.6, max_value=26.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=18.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=4.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=2, max_value=19.9, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=18.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=4.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=20.1, max_value=21.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=18.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=4.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=22.1, max_value=26.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=18.6, max_value=74, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=4.4, allow_nan=False),
           st.floats(min_value=625.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=2, max_value=26.4, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=74, exclude_min=True, allow_nan=False),
           st.floats(min_value=1, max_value=4.4, allow_nan=False),
           st.sampled_from([500, 750, 1750, 2000, 2500, 2750, 3250, 3500, 4750, 5500]),
           st.floats(min_value=26.6, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=16.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.sampled_from([1000, 1250, 1500, 2750, 3000, 3500, 3750, 4250, 5500, 11000]),
           st.floats(min_value=2, max_value=33.9, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=16.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=250, max_value=1374.9, allow_nan=False),
           st.floats(min_value=34.1, max_value=44.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=16.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1375.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=34.1, max_value=37.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=16.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.6, max_value=6.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=1375.1, max_value=12500, exclude_min=True, allow_nan=False),
           st.floats(min_value=37.6, max_value=44.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=16.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.6, max_value=7.4, exclude_min=True, allow_nan=False),
           st.sampled_from([500, 2500, 2750, 3250, 3500, 4250, 5500, 5750, 6000, 11000]),
           st.floats(min_value=2, max_value=44.9, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=16.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.6, max_value=7.4, exclude_min=True, allow_nan=False),
           st.sampled_from([500, 1250, 1500, 1750, 2250, 3250, 3500, 4250, 4500, 4750]),
           st.floats(min_value=45.1, max_value=83.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=16.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=84.1, max_value=89.9, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=16.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=90.1, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=14.6, max_value=16.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.6, max_value=50, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=16.6, max_value=20.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.6, max_value=50, exclude_min=True, allow_nan=False),
           st.sampled_from([250, 2250, 3000, 3250, 3500, 5500, 6500, 8500, 10250, 11500]),
           st.floats(min_value=2, max_value=81.9, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=16.6, max_value=20.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=82.1, max_value=98, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=20.6, max_value=25.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.6, max_value=50, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=25.6, max_value=74, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.6, max_value=50, exclude_min=True, allow_nan=False),
