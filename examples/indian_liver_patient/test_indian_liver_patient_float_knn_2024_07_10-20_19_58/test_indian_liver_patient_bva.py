...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_indian_liver_patient_bva_experiment_data.json')
...
class TestIndianLiverPatientProperty:
    ...
    @given(st.floats(min_value=21.2, max_value=25.49, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.floats(min_value=0.1, max_value=0.14, allow_nan=False),
           st.floats(min_value=181.8, max_value=211.49, allow_nan=False),
           st.floats(min_value=23.2, max_value=26.49, allow_nan=False),
    ...
    @given(st.floats(min_value=21.2, max_value=25.49, allow_nan=False),
           ...
           st.floats(min_value=0.1, max_value=0.14, allow_nan=False),
           st.floats(min_value=181.8, max_value=211.49, allow_nan=False),
           st.floats(min_value=26.51, max_value=30.4, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=21.2, max_value=25.49, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.floats(min_value=0.17, max_value=4.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=181.8, max_value=211.49, allow_nan=False),
           st.floats(min_value=38.8, max_value=45.99, allow_nan=False),
           ...
           st.floats(min_value=1.06, max_value=1.249, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=21.2, max_value=25.49, allow_nan=False),
           ...
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.floats(min_value=0.17, max_value=4.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=163.0, max_value=187.99, allow_nan=False),
           st.floats(min_value=38.8, max_value=45.99, allow_nan=False),
           ...
           st.floats(min_value=1.251, max_value=1.56, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=21.2, max_value=25.49, allow_nan=False),
           ...
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.floats(min_value=0.17, max_value=4.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=188.01, max_value=192.7, exclude_min=True, allow_nan=False),
           st.floats(min_value=38.8, max_value=45.99, allow_nan=False),
    ...
    @given(st.floats(min_value=21.2, max_value=25.49, allow_nan=False),
           ...
           st.floats(min_value=0.1, max_value=0.14, allow_nan=False),
           st.floats(min_value=181.8, max_value=211.49, allow_nan=False),
           st.floats(min_value=46.01, max_value=436.8, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.sampled_from([0.1, 0.4, 0.6, 0.7, 0.8, 1.1, 1.2, 1.4, 1.6, 2.3]),
           st.floats(min_value=128.2, max_value=144.49, allow_nan=False),
           ...
           st.floats(min_value=0.556, max_value=0.619, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=0.68, max_value=0.74, allow_nan=False),
           ...
           st.floats(min_value=0.622, max_value=0.707, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=29.7, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=0.76, max_value=0.93, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=46.51, max_value=55.2, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=0.76, max_value=0.93, exclude_min=True, allow_nan=False),
           st.sampled_from([0.2, 0.3, 0.5, 0.7, 0.8, 1.2, 1.4, 1.6, 3.0, 3.2]),
           st.floats(min_value=108.2, max_value=119.49, allow_nan=False),
    ...
    @given(st.floats(min_value=46.51, max_value=55.2, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=119.51, max_value=124.5, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.052, max_value=1.131, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.floats(min_value=0.22, max_value=0.24, allow_nan=False),
           st.floats(min_value=128.2, max_value=144.49, allow_nan=False),
           ...
           st.floats(min_value=1.451, max_value=1.72, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.floats(min_value=0.27, max_value=4.15, exclude_min=True, allow_nan=False),
           st.floats(min_value=128.2, max_value=144.49, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=27.7, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.sampled_from([0.6, 0.8, 2.2, 2.8, 4.0, 4.2, 4.6, 10.2, 10.8, 12.6]),
           st.floats(min_value=144.51, max_value=157.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=17.6, max_value=19.49, allow_nan=False),
           st.sampled_from([18.0, 32.0, 46.0, 58.0, 130.0, 149.0, 176.0, 350.0, 794.0, 1500.0]),
           st.floats(min_value=5.54, max_value=6.24, allow_nan=False),
           st.sampled_from([1.0, 1.4, 1.5, 1.7, 1.9, 3.2, 3.7, 3.8, 4.0, 5.5]),
           st.floats(min_value=1.404, max_value=1.679, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=36.51, max_value=47.2, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=6.26, max_value=6.92, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.54, max_value=2.94, allow_nan=False),
           st.floats(min_value=1.123, max_value=1.328, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=6.26, max_value=6.37, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.97, max_value=3.06, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.123, max_value=1.328, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=6.87, max_value=7.41, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.97, max_value=3.04, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.123, max_value=1.328, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=6.87, max_value=7.41, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.37, max_value=3.38, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.123, max_value=1.328, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=144.51, max_value=157.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=17.6, max_value=19.49, allow_nan=False),
           st.floats(min_value=12.8, max_value=13.49, allow_nan=False),
           st.floats(min_value=6.26, max_value=6.92, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.47, max_value=3.87, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.123, max_value=1.328, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=144.51, max_value=157.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=17.6, max_value=19.49, allow_nan=False),
           st.floats(min_value=13.51, max_value=996.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.26, max_value=6.92, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.47, max_value=3.87, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.123, max_value=1.328, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.331, max_value=1.4, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=31.9, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=0.75, max_value=0.83, allow_nan=False),
           st.sampled_from([0.1, 1.0, 1.1, 1.3, 2.8, 3.2, 3.7, 3.9, 7.0, 14.1]),
           st.floats(min_value=144.51, max_value=157.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=16.8, max_value=18.49, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=31.9, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=0.86, max_value=0.95, exclude_min=True, allow_nan=False),
           st.sampled_from([0.2, 0.4, 0.6, 0.8, 0.9, 1.1, 1.4, 1.6, 2.3, 3.0]),
           st.floats(min_value=144.51, max_value=157.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=16.8, max_value=18.49, allow_nan=False),
           st.floats(min_value=6.14, max_value=6.99, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=31.9, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=16.8, max_value=18.49, allow_nan=False),
           st.floats(min_value=7.01, max_value=7.26, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=57.51, max_value=60.1, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=29.5, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           st.sampled_from([0.2, 0.4, 0.6, 0.8, 0.9, 1.0, 1.1, 1.2, 2.3, 3.0]),
           st.floats(min_value=144.51, max_value=149.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=29.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           st.floats(min_value=0.1, max_value=0.14, allow_nan=False),
           st.floats(min_value=167.01, max_value=175.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
           st.floats(min_value=3.29, max_value=3.88, allow_nan=False),
           st.floats(min_value=1.404, max_value=1.679, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=29.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
           st.floats(min_value=3.91, max_value=4.22, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.404, max_value=1.679, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=29.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           st.floats(min_value=0.17, max_value=4.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=167.01, max_value=174.1, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
           st.sampled_from([1.8, 2.3, 2.6, 2.8, 3.0, 3.4, 4.1, 4.3, 4.5, 4.7]),
           st.floats(min_value=0.58, max_value=0.649, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=28.1, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           st.floats(min_value=0.17, max_value=4.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=167.01, max_value=171.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.21, max_value=5.83, allow_nan=False),
           st.sampled_from([1.0, 1.8, 2.2, 2.4, 2.8, 3.0, 3.4, 3.6, 3.8, 4.9]),
           st.floats(min_value=0.652, max_value=0.857, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=38.51, max_value=39.9, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           st.floats(min_value=0.17, max_value=4.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=167.01, max_value=171.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=29.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.86, max_value=6.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=29.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.62, max_value=6.95, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=29.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           st.floats(min_value=0.17, max_value=4.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=187.01, max_value=190.1, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=23.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=29.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.17, max_value=4.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=187.01, max_value=190.1, exclude_min=True, allow_nan=False),
           st.floats(min_value=39.01, max_value=431.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=21.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=29.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=187.01, max_value=190.1, exclude_min=True, allow_nan=False),
           st.floats(min_value=39.01, max_value=431.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=32.01, max_value=34.3, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=29.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           st.floats(min_value=0.17, max_value=4.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=202.51, max_value=204.3, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=45.51, max_value=46.7, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           st.floats(min_value=0.22, max_value=0.24, allow_nan=False),
           st.floats(min_value=144.51, max_value=157.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.74, max_value=7.74, allow_nan=False),
    ...
    @given(st.floats(min_value=45.51, max_value=46.7, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.76, max_value=7.86, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=45.51, max_value=46.7, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=0.76, max_value=0.87, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.22, max_value=0.24, allow_nan=False),
           st.floats(min_value=144.51, max_value=157.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=45.51, max_value=46.7, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
           st.floats(min_value=3.5, max_value=4.14, allow_nan=False),
           st.floats(min_value=1.404, max_value=1.679, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=45.51, max_value=46.7, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
           st.floats(min_value=4.17, max_value=4.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.404, max_value=1.679, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=51.51, max_value=55.3, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           st.sampled_from([0.1, 0.2, 0.8, 1.8, 3.0, 3.3, 4.0, 4.9, 5.5, 8.4]),
           st.floats(min_value=144.51, max_value=153.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.46, max_value=6.14, allow_nan=False),
           st.sampled_from([1.9, 2.3, 2.4, 2.5, 2.7, 2.8, 3.0, 4.1, 4.6, 4.7]),
           st.floats(min_value=0.9, max_value=1.049, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=51.51, max_value=53.0, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           ...
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.17, max_value=6.59, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=59.01, max_value=61.3, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
    ...
    @given(st.floats(min_value=51.51, max_value=55.3, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=191.01, max_value=195.1, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=23.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=51.51, max_value=55.3, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.052, max_value=1.177, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=34.5, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.15, max_value=1.33, allow_nan=False),
           st.sampled_from([0.1, 0.3, 0.4, 0.5, 0.6, 0.7, 1.0, 1.2, 1.6, 2.3]),
           st.floats(min_value=144.51, max_value=150.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=23.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=43.51, max_value=1020.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
           st.sampled_from([1.6, 1.9, 2.4, 2.7, 2.8, 2.9, 3.1, 3.4, 4.4, 4.6]),
           st.floats(min_value=0.439, max_value=0.473, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=34.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.476, max_value=0.716, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=25.51, max_value=34.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=144.51, max_value=150.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=40.01, max_value=42.3, exclude_min=True, allow_nan=False),
           st.floats(min_value=43.51, max_value=1020.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=34.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=144.51, max_value=150.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=51.51, max_value=441.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=43.51, max_value=1020.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=34.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=174.51, max_value=176.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=43.51, max_value=1020.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=34.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=186.01, max_value=191.1, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.51, max_value=415.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=43.51, max_value=1020.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.17, max_value=8.28, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=34.5, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.36, max_value=1.41, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=34.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=8.31, max_value=8.56, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=70.51, max_value=74.4, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
    ...
    @given(st.floats(min_value=25.51, max_value=38.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.682, max_value=1.905, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.8, max_value=7.49, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.sampled_from([0.1, 0.5, 0.6, 0.7, 0.9, 1.0, 1.2, 1.6, 3.0, 3.2]),
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=7.51, max_value=24.0, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.sampled_from([0.1, 0.4, 0.5, 0.8, 1.0, 1.6, 2.3, 3.0, 3.2, 3.6]),
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=10.8, max_value=10.99, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
    ...
    @given(st.floats(min_value=7.51, max_value=9.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.4, max_value=1.49, allow_nan=False),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.sampled_from([2.1, 2.2, 2.9, 3.0, 3.3, 4.9, 6.2, 6.4, 8.8, 13.7]),
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
    ...
    @given(st.floats(min_value=7.51, max_value=9.5, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.floats(min_value=0.34, max_value=0.39, allow_nan=False),
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
           st.sampled_from([3.8, 5.1, 5.5, 5.7, 6.1, 6.3, 6.4, 6.8, 8.4, 9.2]),
           st.sampled_from([2.1, 2.2, 2.8, 3.1, 3.3, 3.4, 3.5, 3.6, 3.8, 4.7]),
           st.floats(min_value=1.219, max_value=1.448, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=7.51, max_value=9.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.51, max_value=1.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.floats(min_value=0.42, max_value=4.27, exclude_min=True, allow_nan=False),
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
    ...
    @given(st.floats(min_value=17.51, max_value=32.0, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.floats(min_value=0.3, max_value=0.34, allow_nan=False),
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
           st.sampled_from([5.5, 6.1, 6.3, 6.4, 6.5, 7.2, 7.6, 7.8, 8.4, 9.2]),
           st.sampled_from([2.2, 2.4, 2.6, 2.9, 3.3, 3.7, 4.4, 4.5, 4.9, 5.0]),
           st.floats(min_value=0.508, max_value=0.559, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=17.51, max_value=32.0, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.4, max_value=1.64, allow_nan=False),
           st.floats(min_value=0.37, max_value=4.23, exclude_min=True, allow_nan=False),
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
    ...
    @given(st.floats(min_value=17.51, max_value=25.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.4, max_value=1.49, allow_nan=False),
           st.floats(min_value=0.92, max_value=1.04, allow_nan=False),
           st.sampled_from([2.4, 3.9, 4.5, 7.0, 7.2, 7.7, 11.3, 11.8, 13.7, 17.1]),
           st.floats(min_value=211.51, max_value=214.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=21.6, max_value=24.49, allow_nan=False),
           st.sampled_from([3.0, 5.1, 5.4, 5.5, 5.9, 6.0, 6.3, 6.9, 7.2, 7.6]),
           st.sampled_from([1.6, 1.7, 2.0, 2.1, 2.5, 2.9, 3.0, 3.4, 3.8, 4.2]),
           st.floats(min_value=0.562, max_value=0.679, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=17.51, max_value=25.8, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=211.51, max_value=214.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=24.51, max_value=37.4, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=17.51, max_value=25.8, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=211.51, max_value=214.5, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=73.2, max_value=88.99, allow_nan=False),
    ...
    @given(st.floats(min_value=17.51, max_value=25.8, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.07, max_value=1.14, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=17.51, max_value=25.8, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.23, max_value=1.43, allow_nan=False),
           ...
           st.floats(min_value=1.152, max_value=1.481, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=17.51, max_value=18.0, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.23, max_value=1.43, allow_nan=False),
           st.sampled_from([0.2, 1.1, 3.6, 4.5, 5.6, 7.0, 8.4, 12.1, 12.8, 14.1]),
           st.floats(min_value=226.51, max_value=603.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=73.2, max_value=88.99, allow_nan=False),
           st.sampled_from([2.8, 4.1, 4.4, 4.6, 6.0, 6.2, 6.9, 7.4, 8.4, 8.9]),
           st.sampled_from([1.0, 2.3, 2.4, 2.6, 3.2, 3.3, 3.7, 3.9, 4.5, 5.5]),
           st.floats(min_value=0.562, max_value=1.009, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=20.01, max_value=21.5, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.23, max_value=1.43, allow_nan=False),
    ...
    @given(st.floats(min_value=27.51, max_value=33.8, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.23, max_value=1.43, allow_nan=False),
           st.floats(min_value=0.1, max_value=0.14, allow_nan=False),
           st.floats(min_value=226.51, max_value=603.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=28.0, max_value=32.49, allow_nan=False),
    ...
    @given(st.floats(min_value=27.51, max_value=33.8, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=226.51, max_value=603.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=32.51, max_value=43.8, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=17.51, max_value=25.8, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=408.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=89.01, max_value=92.0, exclude_min=True, allow_nan=False),
           st.sampled_from([2.8, 4.0, 4.6, 5.7, 6.3, 6.7, 7.0, 7.2, 7.4, 7.9]),
           st.sampled_from([2.6, 2.7, 3.1, 3.4, 3.6, 4.0, 4.5, 4.7, 4.9, 5.5]),
           st.floats(min_value=0.562, max_value=0.639, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=17.51, max_value=25.8, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.952, max_value=1.321, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=59.01, max_value=60.3, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.23, max_value=1.43, allow_nan=False),
           st.sampled_from([1.8, 2.1, 2.2, 2.3, 2.8, 5.0, 8.9, 10.2, 10.8, 17.1]),
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=13.3, exclude_min=True, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
    ...
    @given(st.floats(min_value=59.01, max_value=60.3, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=22.51, max_value=418.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
    ...
    @given(st.floats(min_value=65.51, max_value=70.4, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.23, max_value=1.43, allow_nan=False),
           st.sampled_from([1.0, 3.9, 4.3, 5.1, 5.5, 6.1, 7.6, 8.8, 10.8, 18.3]),
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=11.01, max_value=12.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
    ...
    @given(st.floats(min_value=65.51, max_value=70.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=17.01, max_value=17.3, exclude_min=True, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
    ...
    @given(st.floats(min_value=65.51, max_value=70.4, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=211.51, max_value=591.2, exclude_min=True, allow_nan=False),
           st.floats(min_value=18.51, max_value=414.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=85.2, max_value=103.99, allow_nan=False),
    ...
    @given(st.floats(min_value=17.51, max_value=22.9, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.46, max_value=1.49, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=44.51, max_value=53.6, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.46, max_value=1.49, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=7.51, max_value=24.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=104.01, max_value=1069.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([17.0, 21.0, 26.0, 40.0, 42.0, 43.0, 44.0, 45.0, 54.0, 85.0]),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.67, max_value=16.33, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.02, max_value=1.24, allow_nan=False),
           ...
           st.floats(min_value=3.7, max_value=3.94, allow_nan=False),
    ...
    @given(st.floats(min_value=31.6, max_value=38.49, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.67, max_value=1.76, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.86, max_value=1.04, allow_nan=False),
           ...
           st.floats(min_value=134.0, max_value=164.99, allow_nan=False),
           st.floats(min_value=3.97, max_value=4.79, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=31.6, max_value=38.49, allow_nan=False),
           ...
           st.floats(min_value=165.01, max_value=1117.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.97, max_value=4.79, exclude_min=True, allow_nan=False),
           st.sampled_from([1.6, 1.9, 2.3, 2.5, 2.7, 3.0, 3.2, 3.4, 3.8, 4.7]),
           st.floats(min_value=0.939, max_value=1.098, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=31.6, max_value=38.49, allow_nan=False),
           ...
           st.floats(min_value=1.101, max_value=1.44, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=31.6, max_value=38.49, allow_nan=False),
           ...
           st.floats(min_value=8.11, max_value=8.4, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=31.6, max_value=38.49, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.67, max_value=1.76, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.07, max_value=1.1, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.97, max_value=5.09, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=18.8, max_value=22.49, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=2.16, max_value=16.72, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.02, max_value=1.24, allow_nan=False),
           ...
           st.floats(min_value=88.8, max_value=108.49, allow_nan=False),
           st.floats(min_value=3.97, max_value=5.09, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=18.8, max_value=22.49, allow_nan=False),
           ...
           st.floats(min_value=108.51, max_value=1072.6, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.97, max_value=5.09, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=22.51, max_value=25.7, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=2.16, max_value=16.72, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.02, max_value=1.24, allow_nan=False),
    ...
    @given(st.floats(min_value=38.51, max_value=48.8, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.67, max_value=16.33, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.02, max_value=1.24, allow_nan=False),
           ...
           st.floats(min_value=3.97, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.46, max_value=2.84, allow_nan=False),
    ...
    @given(st.floats(min_value=38.51, max_value=43.8, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.67, max_value=16.33, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.02, max_value=1.24, allow_nan=False),
           ...
           st.floats(min_value=3.97, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.87, max_value=3.01, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=38.51, max_value=43.8, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.97, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.62, max_value=3.99, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=65.01, max_value=70.0, exclude_min=True, allow_nan=False),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.67, max_value=16.33, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.02, max_value=1.24, allow_nan=False),
           ...
           st.floats(min_value=3.97, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.87, max_value=3.39, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=38.51, max_value=48.8, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=6.16, max_value=6.84, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([17.0, 18.0, 24.0, 25.0, 28.0, 35.0, 38.0, 53.0, 55.0, 58.0]),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.67, max_value=16.33, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.26, max_value=4.94, exclude_min=True, allow_nan=False),
           st.sampled_from([105.0, 191.0, 194.0, 205.0, 209.0, 216.0, 218.0, 237.0, 247.0, 310.0]),
           st.floats(min_value=11.6, max_value=11.99, allow_nan=False),
    ...
    @given(st.sampled_from([12.0, 14.0, 15.0, 16.0, 27.0, 28.0, 35.0, 53.0, 68.0, 72.0]),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=1.67, max_value=2.54, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.26, max_value=4.94, exclude_min=True, allow_nan=False),
           st.floats(min_value=130.2, max_value=146.99, allow_nan=False),
           st.floats(min_value=12.01, max_value=409.6, exclude_min=True, allow_nan=False),
           st.sampled_from([33.0, 36.0, 92.0, 103.0, 105.0, 155.0, 181.0, 186.0, 231.0, 576.0]),
           st.floats(min_value=4.57, max_value=5.03, allow_nan=False),
    ...
    @given(st.sampled_from([20.0, 23.0, 36.0, 38.0, 40.0, 47.0, 53.0, 64.0, 65.0, 69.0]),
           ...
           st.floats(min_value=5.06, max_value=5.96, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([20.0, 23.0, 31.0, 38.0, 48.0, 49.0, 58.0, 60.0, 64.0, 73.0]),
           st.sampled_from([1.0, 2.0]),
           st.floats(min_value=6.07, max_value=19.85, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.26, max_value=4.94, exclude_min=True, allow_nan=False),
           st.floats(min_value=130.2, max_value=146.99, allow_nan=False),
           st.floats(min_value=12.01, max_value=409.6, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([19.0, 35.0, 37.0, 40.0, 54.0, 62.0, 63.0, 73.0, 74.0, 75.0]),
           ...
           st.floats(min_value=1.67, max_value=16.33, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.26, max_value=4.94, exclude_min=True, allow_nan=False),
           st.floats(min_value=147.01, max_value=241.8, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.01, max_value=409.6, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([16.0, 22.0, 24.0, 49.0, 57.0, 61.0, 63.0, 65.0, 70.0, 72.0]),
           ...
           st.floats(min_value=1.67, max_value=16.33, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.26, max_value=4.94, exclude_min=True, allow_nan=False),
           st.floats(min_value=621.01, max_value=629.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.01, max_value=409.6, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([13.0, 27.0, 33.0, 37.0, 43.0, 49.0, 60.0, 63.0, 66.0, 73.0]),
           ...
           st.floats(min_value=1.67, max_value=16.33, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.26, max_value=4.94, exclude_min=True, allow_nan=False),
           st.floats(min_value=665.51, max_value=845.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.01, max_value=409.6, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([4.0, 17.0, 19.0, 21.0, 38.0, 39.0, 40.0, 54.0, 57.0, 70.0]),
           ...
           st.floats(min_value=1.67, max_value=16.33, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.26, max_value=4.94, exclude_min=True, allow_nan=False),
           st.floats(min_value=1565.01, max_value=1674.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.01, max_value=409.6, exclude_min=True, allow_nan=False),
           st.sampled_from([15.0, 20.0, 26.0, 27.0, 32.0, 54.0, 92.0, 108.0, 110.0, 231.0]),
           st.floats(min_value=5.25, max_value=5.88, allow_nan=False),
    ...
    @given(st.sampled_from([8.0, 16.0, 17.0, 36.0, 52.0, 53.0, 62.0, 65.0, 66.0, 78.0]),
           ...
           st.floats(min_value=5.91, max_value=6.64, exclude_min=True, allow_nan=False),
