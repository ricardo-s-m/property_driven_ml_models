...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_students_knowledge_levels_bva_experiment_data.json')
...
class TestStudentsKnowledgeLevelsProperty:
    ...
    @given(st.sampled_from([0.0, 0.2, 0.25, 0.29, 0.32, 0.36, 0.41, 0.52, 0.55, 0.59]),
           ...
           st.floats(min_value=0.496, max_value=0.619, allow_nan=False),
           st.floats(min_value=0.107, max_value=0.133, allow_nan=False))
    ...
    @given(st.sampled_from([0.05, 0.15, 0.19, 0.24, 0.25, 0.32, 0.33, 0.41, 0.42, 0.51]),
           ...
           st.floats(min_value=0.622, max_value=0.695, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.048, max_value=0.059, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.05, 0.1, 0.12, 0.25, 0.32, 0.33, 0.36, 0.41, 0.54, 0.6]),
           ...
           st.floats(min_value=0.622, max_value=0.695, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.062, max_value=0.067, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.11, 0.12, 0.18, 0.24, 0.35, 0.39, 0.49, 0.56, 0.57, 0.58]),
           ...
           st.floats(min_value=0.622, max_value=0.695, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.091, max_value=0.099, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.05, 0.09, 0.28, 0.29, 0.36, 0.41, 0.45, 0.52, 0.55, 0.68]),
           ...
           st.floats(min_value=0.015, max_value=0.018, allow_nan=False),
           st.floats(min_value=0.136, max_value=0.186, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.04, 0.08, 0.16, 0.18, 0.26, 0.32, 0.33, 0.52, 0.59, 0.6]),
           ...
           st.floats(min_value=0.059, max_value=0.073, allow_nan=False),
           st.floats(min_value=0.021, max_value=0.143, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.136, max_value=0.157, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.02, 0.06, 0.08, 0.11, 0.26, 0.32, 0.33, 0.37, 0.42, 0.55]),
           ...
           st.floats(min_value=0.059, max_value=0.073, allow_nan=False),
           st.floats(min_value=0.021, max_value=0.143, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.246, max_value=0.274, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.08, 0.1, 0.2, 0.25, 0.26, 0.28, 0.29, 0.33, 0.54, 0.55]),
           st.floats(min_value=0.588, max_value=0.734, allow_nan=False),
           st.floats(min_value=0.076, max_value=0.25, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.021, max_value=0.074, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.136, max_value=0.149, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.02, 0.08, 0.15, 0.26, 0.29, 0.37, 0.51, 0.52, 0.55, 0.68]),
           st.floats(min_value=0.588, max_value=0.734, allow_nan=False),
           st.floats(min_value=0.076, max_value=0.25, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.291, max_value=0.359, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.136, max_value=0.149, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.09, 0.19, 0.2, 0.28, 0.31, 0.33, 0.35, 0.55, 0.6, 0.64]),
           ...
           st.floats(min_value=0.076, max_value=0.25, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.021, max_value=0.143, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.206, max_value=0.242, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.12, 0.13, 0.14, 0.15, 0.19, 0.26, 0.4, 0.41, 0.64, 0.79]),
           st.floats(min_value=0.737, max_value=0.769, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.076, max_value=0.25, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.021, max_value=0.143, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.136, max_value=0.162, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.02, 0.05, 0.12, 0.13, 0.19, 0.28, 0.33, 0.38, 0.51, 0.6]),
           ...
           st.floats(min_value=0.076, max_value=0.25, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.021, max_value=0.143, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.271, max_value=0.294, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.1, 0.14, 0.16, 0.24, 0.25, 0.26, 0.3, 0.41, 0.58, 0.6]),
           ...
           st.floats(min_value=0.636, max_value=0.647, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.136, max_value=0.157, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.05, 0.09, 0.15, 0.28, 0.3, 0.33, 0.39, 0.5, 0.54, 0.6]),
           st.floats(min_value=0.215, max_value=0.268, allow_nan=False),
           st.sampled_from([0.08, 0.18, 0.32, 0.35, 0.5, 0.54, 0.62, 0.7, 0.75, 0.8]),
           st.floats(min_value=0.636, max_value=0.647, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.246, max_value=0.255, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.1, 0.12, 0.19, 0.28, 0.29, 0.34, 0.42, 0.48, 0.51, 0.78]),
           st.floats(min_value=0.271, max_value=0.396, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.02, 0.18, 0.26, 0.32, 0.38, 0.49, 0.51, 0.64, 0.65, 0.69]),
           ...
           st.floats(min_value=0.696, max_value=0.711, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.136, max_value=0.167, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.06, 0.16, 0.2, 0.24, 0.46, 0.7, 0.71, 0.76, 0.79, 0.8]),
           ...
           st.floats(min_value=0.636, max_value=0.663, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.297, max_value=0.315, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.02, 0.13, 0.14, 0.25, 0.28, 0.3, 0.51, 0.54, 0.68, 0.73]),
           ...
           st.floats(min_value=0.776, max_value=0.818, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.136, max_value=0.154, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.071, max_value=0.088, allow_nan=False),
           ...
           st.floats(min_value=0.776, max_value=0.818, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.231, max_value=0.262, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.091, max_value=0.27, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.02, 0.12, 0.15, 0.3, 0.32, 0.33, 0.37, 0.39, 0.41, 0.64]),
           ...
           st.floats(min_value=0.1, max_value=0.124, allow_nan=False),
           st.floats(min_value=0.392, max_value=0.448, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.15, 0.16, 0.24, 0.27, 0.4, 0.42, 0.7, 0.73, 0.75, 0.76]),
           ...
           st.floats(min_value=0.091, max_value=0.113, allow_nan=False),
           st.floats(min_value=0.127, max_value=0.267, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.392, max_value=0.448, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.2, 0.24, 0.26, 0.28, 0.29, 0.31, 0.39, 0.42, 0.5, 0.62]),
           ...
           st.floats(min_value=0.116, max_value=0.276, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.664, max_value=0.829, allow_nan=False),
           st.floats(min_value=0.392, max_value=0.448, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.08, 0.11, 0.13, 0.22, 0.23, 0.33, 0.45, 0.61, 0.83, 0.91]),
           ...
           st.floats(min_value=0.921, max_value=0.926, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.664, max_value=0.829, allow_nan=False),
           st.floats(min_value=0.392, max_value=0.448, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.1, 0.22, 0.41, 0.46, 0.6, 0.66, 0.75, 0.78, 0.8, 0.88]),
           ...
           st.floats(min_value=0.832, max_value=0.863, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.392, max_value=0.448, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.11, 0.15, 0.32, 0.39, 0.5, 0.6, 0.66, 0.7, 0.78, 0.8]),
           ...
           st.floats(min_value=0.324, max_value=0.404, allow_nan=False),
           st.floats(min_value=0.067, max_value=0.083, allow_nan=False),
           st.floats(min_value=0.677, max_value=0.739, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.08, 0.09, 0.1, 0.15, 0.26, 0.44, 0.47, 0.66, 0.77, 0.8]),
           ...
           st.floats(min_value=0.407, max_value=0.515, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.067, max_value=0.083, allow_nan=False),
           st.floats(min_value=0.677, max_value=0.739, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.12, 0.18, 0.24, 0.3, 0.43, 0.44, 0.75, 0.83, 0.85, 0.9]),
           st.floats(min_value=0.668, max_value=0.834, allow_nan=False),
           st.sampled_from([0.04, 0.07, 0.15, 0.25, 0.31, 0.38, 0.46, 0.68, 0.91, 0.95]),
           st.floats(min_value=0.086, max_value=0.266, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.677, max_value=0.739, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.0, 0.08, 0.3, 0.45, 0.48, 0.49, 0.54, 0.78, 0.85, 0.99]),
           st.floats(min_value=0.837, max_value=0.842, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.312, max_value=0.389, allow_nan=False),
           st.floats(min_value=0.086, max_value=0.266, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.677, max_value=0.739, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.15, 0.17, 0.19, 0.26, 0.39, 0.4, 0.45, 0.62, 0.75, 0.76]),
           st.floats(min_value=0.837, max_value=0.842, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.392, max_value=0.503, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.086, max_value=0.266, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.677, max_value=0.739, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.09, 0.15, 0.21, 0.32, 0.38, 0.4, 0.46, 0.66, 0.8, 0.83]),
           st.floats(min_value=0.867, max_value=0.873, exclude_min=True, allow_nan=False),
