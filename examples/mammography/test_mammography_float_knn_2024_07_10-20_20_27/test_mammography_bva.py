...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_mammography_bva_experiment_data.json')
...
class TestMammographyProperty:
    ...
    @given(st.floats(min_value=0.855414, max_value=1.265371, allow_nan=False),
           st.floats(min_value=-0.463119, max_value=-0.46135, allow_nan=False),
           st.sampled_from([-0.32114211, -0.050652758, 0.94114155, 1.1665493, 1.4821203, 2.834567, 4.2320954, 4.6378294, 5.088645, 9.4164747]),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    ...
    @given(st.floats(min_value=0.855414, max_value=1.265371, allow_nan=False),
           st.floats(min_value=-0.461347, max_value=-0.440557, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=-0.147536, max_value=0.011683, allow_nan=False),
           st.floats(min_value=-0.357392, max_value=-0.356508, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.375241, max_value=-0.321144, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.011686, max_value=0.262422, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.357392, max_value=-0.356508, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.375241, max_value=-0.321144, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=0.855414, max_value=1.265371, allow_nan=False),
           st.floats(min_value=-0.357392, max_value=-0.356508, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.321141, max_value=5.638641, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.261558, max_value=0.523051, allow_nan=False),
           st.floats(min_value=-0.352968, max_value=-0.351642, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.261558, max_value=0.523051, allow_nan=False),
           st.floats(min_value=-0.346333, max_value=-0.345007, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    ...
    @given(st.floats(min_value=0.523054, max_value=0.671517, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.352968, max_value=-0.350315, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    ...
    @given(st.floats(min_value=0.855414, max_value=1.265371, allow_nan=False),
           st.floats(min_value=-0.339698, max_value=-0.325543, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    ...
    @given(st.floats(min_value=-0.001798, max_value=0.193855, allow_nan=False),
           st.floats(min_value=-0.26892, max_value=-0.268036, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    ...
    @given(st.floats(min_value=0.193858, max_value=0.40816, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.26892, max_value=-0.268036, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=-0.063657, max_value=0.116532, allow_nan=False),
           st.floats(min_value=-0.352968, max_value=-0.335275, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.116535, max_value=0.116686, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.352968, max_value=-0.335275, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=0.117297, max_value=0.346911, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.352968, max_value=-0.335275, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=0.855414, max_value=1.265371, allow_nan=False),
           st.floats(min_value=-0.264496, max_value=0.805573, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.147705, max_value=0.332539, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.638198, max_value=0.99385, allow_nan=False),
           st.floats(min_value=-0.264496, max_value=0.188922, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.332542, max_value=6.161587, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.638198, max_value=0.99385, allow_nan=False),
           st.floats(min_value=2.0026, max_value=2.022505, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.332542, max_value=6.161587, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    ...
    @given(st.floats(min_value=0.638198, max_value=0.99385, allow_nan=False),
           st.floats(min_value=2.102131, max_value=2.698874, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.332542, max_value=6.161587, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    ...
    @given(st.floats(min_value=0.993853, max_value=1.004777, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.264496, max_value=0.805573, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.332542, max_value=6.161587, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=1.04848, max_value=1.091858, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.264496, max_value=0.805573, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.332542, max_value=6.161587, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.711029, max_value=-0.673899, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=0.855414, max_value=1.265371, allow_nan=False),
           ...
           st.floats(min_value=-0.673896, max_value=-0.039082, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.265374, max_value=1.265509, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.266052, max_value=1.26639, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.267746, max_value=1.267864, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.268339, max_value=1.354537, exclude_min=True, allow_nan=False),
           st.sampled_from([-0.26670963, -0.14284877, 0.31720586, 0.52953877, 1.4319536, 1.6885226, 2.6617151, 2.7192219, 4.1568926, 4.4665448]),
           st.floats(min_value=-0.068686, max_value=0.06205, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.268339, max_value=1.354537, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.326871, max_value=-0.291041, allow_nan=False),
           st.floats(min_value=0.062053, max_value=5.945196, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.268339, max_value=1.354537, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.291038, max_value=-0.218492, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.062053, max_value=5.945196, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    ...
    @given(st.floats(min_value=1.268339, max_value=1.354537, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.071697, max_value=1.074527, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.062053, max_value=5.945196, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.618051, max_value=1.008994, allow_nan=False))
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           ...
           st.floats(min_value=-0.555567, max_value=-0.546551, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.072376, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.396461, max_value=-0.299473, allow_nan=False),
           ...
           st.floats(min_value=-0.546548, max_value=-0.514992, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.072376, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.29947, max_value=-0.16781, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.341027, max_value=-0.308735, allow_nan=False),
           st.floats(min_value=-0.546548, max_value=-0.514992, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.072376, exclude_min=True, allow_nan=False))
    ...
    @given(st.floats(min_value=0.358837, max_value=0.626935, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.341027, max_value=-0.308735, allow_nan=False),
           st.floats(min_value=-0.546548, max_value=-0.514992, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=-0.29947, max_value=0.10029, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.308732, max_value=0.770184, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.546548, max_value=-0.514992, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.072376, exclude_min=True, allow_nan=False))
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           st.floats(min_value=-0.450732, max_value=-0.445867, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=0.06656, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.598011, max_value=0.962401, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.056531, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           st.floats(min_value=-0.450732, max_value=-0.445867, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=0.06656, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.962404, max_value=0.964386, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.056531, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           st.floats(min_value=-0.450732, max_value=-0.445867, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=0.06656, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.97232, max_value=1.277891, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.056531, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           ...
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.246671, max_value=1.247279, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           ...
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.249718, max_value=1.264953, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           st.floats(min_value=-0.450732, max_value=-0.445867, allow_nan=False),
           st.floats(min_value=1.887856, max_value=7.405838, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.045561, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           ...
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.191823, max_value=1.218637, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.427079, max_value=0.729952, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=-0.140815, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.71008, max_value=1.102487, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.013262, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.427079, max_value=0.729952, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.85098, max_value=6.576337, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.71008, max_value=1.102487, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.012348, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.427079, max_value=0.729952, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.85098, max_value=6.576337, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.116425, max_value=0.069356, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.025756, max_value=1.026669, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.427079, max_value=0.729952, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.85098, max_value=6.576337, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.069359, max_value=0.275984, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.025756, max_value=1.026669, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.427079, max_value=0.729952, allow_nan=False),
           ...
           st.floats(min_value=0.71008, max_value=1.102487, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.030326, max_value=1.089439, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.427079, max_value=0.729952, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.10249, max_value=1.102658, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.072376, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.178154, max_value=0.418795, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.103334, max_value=1.382702, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.072376, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.418798, max_value=0.419407, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.103334, max_value=1.382702, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=0.421847, max_value=0.431772, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.103334, max_value=1.382702, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=0.471476, max_value=0.471712, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.103334, max_value=1.382702, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=0.472662, max_value=0.52412, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.103334, max_value=1.382702, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=0.729955, max_value=0.73158, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=0.660478, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=0.738085, max_value=0.930334, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.445864, max_value=-0.414015, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.072376, exclude_min=True, allow_nan=False))
    ...
    @given(st.floats(min_value=0.738085, max_value=0.930334, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.286614, max_value=0.787878, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.828232, max_value=2.500178, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.008997, max_value=1.072376, exclude_min=True, allow_nan=False))
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           ...
           st.floats(min_value=2.500181, max_value=2.505074, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.493509, max_value=0.711352, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           ...
           st.floats(min_value=2.524653, max_value=2.760224, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.493509, max_value=0.711352, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.202582, max_value=1.69933, allow_nan=False),
           ...
           st.floats(min_value=2.500181, max_value=2.740646, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.711355, max_value=0.87871, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.699333, max_value=1.699806, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=2.790096, max_value=3.702508, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.701705, max_value=1.702856, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.48612, max_value=2.072537, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.707464, max_value=1.708445, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.712376, max_value=2.118504, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.351643, max_value=-0.322006, allow_nan=False),
    ...
    @given(st.floats(min_value=3.743023, max_value=3.744614, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.351643, max_value=-0.322006, allow_nan=False),
    ...
    @given(st.floats(min_value=3.750984, max_value=9.302475, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.351643, max_value=-0.322006, allow_nan=False),
    ...
    @given(st.floats(min_value=1.712376, max_value=1.833975, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.322003, max_value=-0.041105, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.375241, max_value=-0.321144, allow_nan=False),
           st.floats(min_value=1.48612, max_value=2.072537, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    ...
    @given(st.floats(min_value=2.320376, max_value=8.157989, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.322003, max_value=-0.093304, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.375241, max_value=-0.321144, allow_nan=False),
           st.floats(min_value=1.166792, max_value=1.673378, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=2.320376, max_value=8.157989, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.821498, max_value=0.873695, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.375241, max_value=-0.321144, allow_nan=False),
           st.floats(min_value=1.166792, max_value=1.673378, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    ...
    @given(st.floats(min_value=2.320376, max_value=8.157989, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.322003, max_value=-0.041105, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.375241, max_value=-0.321144, allow_nan=False),
           st.floats(min_value=1.673381, max_value=1.753212, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.712376, max_value=7.671589, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.322003, max_value=-0.041105, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.321141, max_value=5.638641, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.48612, max_value=2.072537, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
    ...
    @given(st.floats(min_value=1.712376, max_value=7.671589, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.082491, max_value=1.883162, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.701705, max_value=7.663052, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=2.07254, max_value=2.099079, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.701705, max_value=7.663052, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=2.205241, max_value=2.504694, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.439577, max_value=0.643937, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.701705, max_value=7.663052, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=2.205241, max_value=2.504694, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.64394, max_value=0.824778, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.87157, max_value=1.325893, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.10569738, 0.004570916, 0.49493453, 0.53558643, 0.60215393, 0.96412527, 1.1285961, 1.1465507, 1.3919866, 1.7014492]),
           ...
           st.floats(min_value=-0.357208, max_value=-0.298603, allow_nan=False),
           st.floats(min_value=2.790096, max_value=3.702508, allow_nan=False),
           st.floats(min_value=0.640251, max_value=0.894779, allow_nan=False),
           st.floats(min_value=1.325896, max_value=1.326504, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.45767513, -0.43887362, -0.35926364, -0.2881228, -0.18835625, 0.047932949, 0.066226306, 0.27422856, 0.31860689, 0.34553877]),
           ...
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=0.527462, max_value=0.874215, allow_nan=False),
           st.floats(min_value=0.640251, max_value=0.894779, allow_nan=False),
           st.floats(min_value=1.328943, max_value=1.36307, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.10688306, -0.028458757, 0.26914707, 0.40126576, 0.40651663, 0.44310335, 1.7014492, 1.7614108, 2.2592272, 6.1960255]),
           ...
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=0.874218, max_value=0.87523, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.640251, max_value=0.894779, allow_nan=False),
           st.floats(min_value=1.328943, max_value=1.36307, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.42041088, -0.39161578, -0.29557565, -0.18022587, -0.029983204, 0.14922395, 0.77272255, 0.937024, 1.2839203, 1.3553999]),
           ...
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=0.879281, max_value=1.443926, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.640251, max_value=0.894779, allow_nan=False),
           st.floats(min_value=1.328943, max_value=1.36307, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.51492656, -0.35773919, -0.20783529, 0.050812459, 0.2191791, 0.43700556, 0.91009211, 0.96717417, 1.3884295, 5.1861644]),
           ...
           st.floats(min_value=-0.388763, max_value=-0.370732, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.790096, max_value=3.702508, allow_nan=False),
           st.floats(min_value=0.640251, max_value=0.894779, allow_nan=False),
           st.floats(min_value=1.328943, max_value=1.36307, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.343269, max_value=0.625189, allow_nan=False),
           ...
           st.floats(min_value=2.790096, max_value=3.702508, allow_nan=False),
           st.floats(min_value=0.640251, max_value=0.894779, allow_nan=False),
           st.floats(min_value=1.499581, max_value=1.506284, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.625192, max_value=6.801842, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.48511516, -0.17243426, 0.26711447, 0.2698246, 0.29878908, 0.34791014, 0.45919473, 0.62468186, 0.7891527, 2.4557114]),
           ...
           st.floats(min_value=2.790096, max_value=3.702508, allow_nan=False),
           st.floats(min_value=0.640251, max_value=0.894779, allow_nan=False),
           st.floats(min_value=1.533099, max_value=1.542239, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.58708369, -0.31353025, -0.0072858899, 0.026421315, 0.044714673, 0.29387698, 0.3343595, 0.62959397, 0.72326273, 1.5010692]),
           ...
           st.floats(min_value=-0.2986, max_value=5.656673, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.840713, max_value=1.265779, allow_nan=False),
           st.floats(min_value=0.451115, max_value=0.658359, allow_nan=False),
           st.floats(min_value=1.325896, max_value=1.376477, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.028458757, 0.11670242, 0.1605726, 0.23882752, 0.26914707, 0.47867377, 0.91415731, 1.2596985, 1.8916663, 2.5654716]),
           ...
           st.floats(min_value=-0.2986, max_value=5.656673, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.265782, max_value=1.266287, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.451115, max_value=0.658359, allow_nan=False),
           st.floats(min_value=1.325896, max_value=1.376477, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.47817046, 0.095698938, 0.16700916, 0.2073223, 0.23069714, 0.4058391, 0.43243222, 0.59165219, 1.7920691, 2.6809908]),
           ...
           st.floats(min_value=-0.2986, max_value=5.656673, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.268314, max_value=1.755152, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.451115, max_value=0.658359, allow_nan=False),
           st.floats(min_value=1.325896, max_value=1.376477, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.25001164, -0.03726667, 0.15176469, 0.37365634, 0.40126576, 0.46004164, 0.89027431, 1.4033352, 2.3191888, 2.8701915]),
           ...
           st.floats(min_value=-0.2986, max_value=5.656673, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.790096, max_value=3.702508, allow_nan=False),
           st.floats(min_value=0.658362, max_value=0.705645, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.325896, max_value=1.327723, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.50815124, -0.5056105, -0.2325652, -0.15193892, 0.10078043, 0.31504985, 0.32267208, 0.38856204, 0.85741402, 1.3279598]),
           ...
           st.floats(min_value=-0.2986, max_value=5.656673, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.321055, max_value=1.866206, allow_nan=False),
           st.floats(min_value=0.658362, max_value=0.705645, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.335037, max_value=1.38379, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.23087137, -0.012536761, 0.11145155, 0.13787529, 0.40922676, 0.56065511, 0.72681977, 0.73088496, 0.81354384, 1.4033352]),
           ...
           st.floats(min_value=-0.2986, max_value=5.656673, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.866209, max_value=2.233468, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.658362, max_value=0.705645, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.335037, max_value=1.38379, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.21949, max_value=-0.078259, allow_nan=False),
           ...
           st.floats(min_value=0.333874, max_value=0.63223, allow_nan=False),
           st.floats(min_value=0.894782, max_value=1.025452, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.325896, max_value=1.376477, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.21949, max_value=-0.078259, allow_nan=False),
           ...
           st.floats(min_value=0.632233, max_value=0.705946, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.894782, max_value=1.025452, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.325896, max_value=1.376477, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.078256, max_value=6.239083, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.628728, max_value=1.000798, allow_nan=False),
           st.floats(min_value=0.894782, max_value=1.025452, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.325896, max_value=1.376477, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.03726667, 0.047932949, 0.085705344, 0.12347774, 0.33063308, 0.5449025, 0.91415731, 3.7918041, 6.1960255, 6.2441303]),
           st.floats(min_value=-0.365799, max_value=-0.339701, allow_nan=False),
           ...
           st.floats(min_value=1.000801, max_value=1.541142, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.894782, max_value=1.025452, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.325896, max_value=1.376477, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.122393, max_value=0.349094, allow_nan=False),
           st.floats(min_value=-0.339698, max_value=0.745411, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.349097, max_value=6.580966, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.339698, max_value=-0.301214, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.349097, max_value=6.580966, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.147271, max_value=0.899353, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.45293241, -0.32996039, -0.26796624, -0.22409605, -0.05047854, 0.047086034, 0.065040626, 0.27219596, 0.29235253, 0.96344774]),
           ...
           st.floats(min_value=0.801726, max_value=1.217045, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.578805, max_value=1.623597, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.25577066, -0.05742324, -0.028797523, 0.07740558, 0.099086597, 0.22155046, 0.24289271, 0.46393745, 0.51695431, 0.54710447]),
           ...
           st.floats(min_value=0.600205, max_value=0.965144, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.802768, max_value=1.832019, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.48697838, -0.17768513, -0.15769794, 0.016258339, 0.022356125, 0.56201017, 0.78288553, 0.93092622, 1.846441, 3.4164515]),
           st.floats(min_value=-0.406496, max_value=-0.390572, allow_nan=False),
           st.sampled_from([-0.45638679, 0.08459192, 0.98622311, 2.8796486, 3.3304642, 3.555872, 3.6911167, 4.0968507, 4.2320954, 5.4042159]),
           st.floats(min_value=0.965147, max_value=1.015526, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.162934, max_value=1.548133, allow_nan=False),
           st.floats(min_value=1.802768, max_value=1.832019, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([0.032857867, 0.23764184, 0.39872502, 0.42294678, 0.87265849, 1.0974296, 1.2049878, 1.2659657, 1.297979, 2.8701915]),
           st.floats(min_value=-0.390569, max_value=0.704714, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.43328398, -0.26627241, -0.18378291, -0.18124217, -0.12399074, 0.097731533, 0.11128217, 0.13397948, 0.24441716, 0.35451607]),
           ...
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=1.217048, max_value=1.237891, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.714187, max_value=0.9872, allow_nan=False),
           st.floats(min_value=1.578805, max_value=1.652849, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.46123217, -0.061657814, 0.087229791, 0.10891081, 0.31064589, 0.50746887, 0.7156405, 1.1086089, 4.1664791, 5.0267751]),
           ...
           st.floats(min_value=-0.429339, max_value=-0.388766, allow_nan=False),
           st.floats(min_value=1.321268, max_value=1.797516, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.714187, max_value=0.9872, allow_nan=False),
           st.floats(min_value=1.578805, max_value=1.652849, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.44039807, -0.42193533, -0.32945224, -0.28100872, -0.26254598, 0.041327014, 0.37789092, 0.74375807, 1.0611817, 1.3938498]),
           ...
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.217048, max_value=1.37823, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.714187, max_value=0.9872, allow_nan=False),
           st.floats(min_value=1.578805, max_value=1.652849, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.15024509, -0.042178776, 0.02150921, 0.085705344, 0.48714291, 0.49713651, 0.61350259, 0.69243504, 0.73359509, 1.2815489]),
           ...
           st.floats(min_value=-0.388763, max_value=5.584543, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.022962, max_value=2.358871, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.714187, max_value=0.9872, allow_nan=False),
           st.floats(min_value=1.578805, max_value=1.652849, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.32183001, -0.043872605, 0.15413605, 0.17920473, 0.27947943, 0.31064589, 0.61350259, 1.0217155, 1.2361543, 1.2815489]),
           ...
           st.floats(min_value=1.217048, max_value=1.71414, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.987203, max_value=1.099389, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.578805, max_value=1.652849, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.173208, max_value=0.412613, allow_nan=False),
           ...
           st.floats(min_value=0.751936, max_value=1.154808, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.749685, max_value=1.173537, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.412616, max_value=0.426352, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.751936, max_value=1.154808, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.641209, max_value=1.037941, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.412616, max_value=0.426352, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.614889, max_value=0.983499, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.037944, max_value=1.065062, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.412616, max_value=0.426352, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.983502, max_value=1.017763, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.037944, max_value=1.065062, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.481301, max_value=6.686729, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.226013, max_value=-0.164968, allow_nan=False),
           ...
           st.floats(min_value=0.751936, max_value=1.154808, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.568078, max_value=0.946528, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.481301, max_value=6.686729, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.751936, max_value=1.154808, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.946531, max_value=0.991932, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.481301, max_value=6.686729, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.164965, max_value=0.885197, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.38026712, -0.28151687, -0.27321711, -0.25356869, -0.25289115, -0.24205065, -0.19292959, -0.1194174, 0.51017899, 0.78305491]),
           ...
           st.floats(min_value=0.428727, max_value=0.750796, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.17354, max_value=1.328637, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.273014, max_value=-0.145165, allow_nan=False),
           st.floats(min_value=-0.422421, max_value=-0.410478, allow_nan=False),
           st.floats(min_value=0.057542, max_value=0.219835, allow_nan=False),
           st.floats(min_value=0.750799, max_value=0.8316, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.17354, max_value=1.328637, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.273014, max_value=-0.145165, allow_nan=False),
           st.floats(min_value=-0.422421, max_value=-0.410478, allow_nan=False),
           st.floats(min_value=0.219838, max_value=6.071424, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.750799, max_value=0.8316, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.17354, max_value=1.328637, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.145162, max_value=6.185559, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.422421, max_value=-0.410478, allow_nan=False),
    ...
    @given(st.floats(min_value=0.347334, max_value=0.63027, allow_nan=False),
           st.floats(min_value=-0.410475, max_value=0.688789, exclude_min=True, allow_nan=False),
           st.sampled_from([1.5722834, 1.6173649, 2.0681805, 3.6911167, 3.8714429, 3.961606, 4.0066876, 4.9083188, 4.9984819, 13.473815]),
           st.floats(min_value=0.750799, max_value=0.812022, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.17354, max_value=1.245451, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.347334, max_value=0.63027, allow_nan=False),
           st.floats(min_value=-0.410475, max_value=-0.400302, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.750799, max_value=0.812022, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.533099, max_value=1.616284, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.347334, max_value=0.63027, allow_nan=False),
           st.floats(min_value=-0.359604, max_value=0.729486, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.347334, max_value=0.63027, allow_nan=False),
           ...
           st.floats(min_value=1.05692, max_value=1.062657, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.17354, max_value=1.328637, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.347334, max_value=0.63027, allow_nan=False),
           ...
           st.floats(min_value=1.085612, max_value=1.099451, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.17354, max_value=1.328637, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.630273, max_value=6.805906, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.410475, max_value=-0.358278, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.630273, max_value=6.805906, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.149483, max_value=0.897583, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=-0.469295, max_value=-0.390516, allow_nan=False),
           st.floats(min_value=-0.224243, max_value=-0.162756, allow_nan=False),
           ...
           st.floats(min_value=1.154811, max_value=1.66435, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.949576, max_value=1.4234, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.390513, max_value=-0.276401, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.224243, max_value=-0.162756, allow_nan=False),
           st.sampled_from([0.35508128, 1.5272018, 1.6173649, 2.6091592, 3.4206273, 3.8714429, 4.1419323, 4.9083188, 6.9369889, 20.686865]),
           st.floats(min_value=1.154811, max_value=1.66435, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.82891, max_value=1.272568, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.390513, max_value=-0.287224, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.224243, max_value=-0.162756, allow_nan=False),
           st.sampled_from([0.17475504, 0.62557063, 1.0313047, 1.4370387, 1.7075281, 4.1870138, 5.2689712, 7.7935386, 9.4164747, 14.645936]),
           st.floats(min_value=1.154811, max_value=1.201393, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.272571, max_value=1.302736, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.390513, max_value=-0.287224, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.387724, max_value=1.85068, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.272571, max_value=1.302736, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.125935, max_value=0.136758, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.224243, max_value=-0.162756, allow_nan=False),
    ...
    @given(st.floats(min_value=0.180053, max_value=0.345607, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.280866, max_value=-0.233534, allow_nan=False),
           st.floats(min_value=-0.393273, max_value=-0.343684, allow_nan=False),
           st.floats(min_value=1.154811, max_value=1.66435, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.949576, max_value=1.4234, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.180053, max_value=0.345607, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.233531, max_value=-0.219376, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.393273, max_value=-0.343684, allow_nan=False),
           st.floats(min_value=1.154811, max_value=1.66435, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.949576, max_value=1.4234, allow_nan=False))
    ...
    @given(st.floats(min_value=1.007828, max_value=7.107951, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.224243, max_value=-0.162756, allow_nan=False),
           st.floats(min_value=-0.393273, max_value=-0.343684, allow_nan=False),
           st.floats(min_value=1.154811, max_value=1.66435, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.180053, max_value=6.445731, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.224243, max_value=-0.162756, allow_nan=False),
           st.floats(min_value=-0.343681, max_value=5.620609, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.154811, max_value=1.66435, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.949576, max_value=1.4234, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=2.843699, max_value=3.750727, allow_nan=False),
           st.floats(min_value=-0.162753, max_value=0.650746, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.159762, max_value=1.645805, allow_nan=False),
           st.floats(min_value=3.904749, max_value=4.140969, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.645808, max_value=2.066791, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.904749, max_value=4.140969, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=3.75073, max_value=9.302272, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.162753, max_value=0.886967, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.035064692, 0.017613402, 0.046577885, 0.37467264, 0.3780603, 0.42294678, 0.45123373, 0.50746887, 2.0158239, 3.7801167]),
           ...
           st.floats(min_value=1.154811, max_value=1.66435, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.423403, max_value=1.473984, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.44615709, -0.38229972, -0.27643538, -0.0037288481, 0.016935871, 0.23001961, 0.25271692, 0.88112763, 0.95853564, 1.5178381]),
           ...
           st.floats(min_value=1.154811, max_value=1.66435, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.548136, max_value=1.844706, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.676313, max_value=1.730855, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.373486, max_value=0.662961, allow_nan=False),
           ...
           st.floats(min_value=3.702511, max_value=3.716307, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.478582, max_value=1.942693, allow_nan=False),
    ...
    @given(st.floats(min_value=0.373486, max_value=0.662961, allow_nan=False),
           ...
           st.floats(min_value=3.771499, max_value=4.935432, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.478582, max_value=1.942693, allow_nan=False),
    ...
    @given(st.floats(min_value=0.373486, max_value=0.662961, allow_nan=False),
           ...
           st.floats(min_value=3.702511, max_value=4.880241, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.942696, max_value=2.160354, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.662964, max_value=6.832059, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.378185, max_value=-0.355183, allow_nan=False),
           st.sampled_from([0.44524439, 0.49032595, 1.0763862, 3.1050564, 4.1870138, 7.0271521, 8.0189464, 14.645936, 20.055723, 20.686865]),
           st.floats(min_value=3.702511, max_value=4.880241, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.349219, max_value=3.03099, allow_nan=False),
    ...
    @given(st.floats(min_value=0.662964, max_value=2.575787, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.35518, max_value=0.198654, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.662964, max_value=2.575787, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.413995, max_value=2.948365, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=10.227087, max_value=14.483358, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.35518, max_value=0.733025, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.5045942, -0.30946506, -0.27508032, 0.0057565965, 0.43971569, 0.69531455, 0.81981101, 0.89942099, 1.6570709, 5.883514]),
           ...
           st.floats(min_value=0.780628, max_value=1.190673, allow_nan=False),
           st.floats(min_value=3.030993, max_value=3.427571, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.783813, max_value=1.216197, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.23087137, 0.15176469, 0.15413605, 0.23882752, 0.33063308, 0.36230769, 0.48714291, 0.61350259, 3.389689, 5.0267751]),
           st.floats(min_value=-0.270249, max_value=-0.220263, allow_nan=False),
           ...
           st.floats(min_value=0.780628, max_value=1.190673, allow_nan=False),
           st.floats(min_value=3.030993, max_value=3.175666, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.2162, max_value=1.262515, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.27474155, -0.16769153, 0.049457395, 0.11839625, 0.12415527, 0.17259879, 0.19072277, 0.89298444, 1.3648853, 1.3940192]),
           st.floats(min_value=-0.22026, max_value=0.840961, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.44547956, -0.35790858, -0.19902738, -0.18615427, 0.0054178307, 0.49069995, 0.52677852, 0.67702119, 0.69853282, 1.6475854]),
           ...
           st.floats(min_value=0.780628, max_value=1.190673, allow_nan=False),
           st.floats(min_value=3.754363, max_value=4.006267, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.2162, max_value=1.262515, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.15024509, 0.087229791, 0.19749808, 0.53457014, 0.55930005, 0.7156405, 1.1072539, 3.7472564, 3.7801167, 4.6939376]),
           ...
           st.floats(min_value=0.780628, max_value=1.190673, allow_nan=False),
           st.floats(min_value=3.030993, max_value=3.427571, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.44778, max_value=1.470328, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.28100872, -0.21647382, -0.20783529, -0.13872705, -0.091469211, -0.068602514, 0.072324092, 0.48765106, 0.62366556, 1.6533445]),
           ...
           st.floats(min_value=0.780628, max_value=1.190673, allow_nan=False),
           st.floats(min_value=3.030993, max_value=3.427571, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.560523, max_value=1.638223, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.36671649, -0.22341852, -0.13381495, -0.11670727, -0.036250373, 0.22239738, 0.70208986, 0.73579707, 0.79541986, 0.84352462]),
           ...
           st.floats(min_value=0.780628, max_value=1.190673, allow_nan=False),
           st.floats(min_value=5.013888, max_value=8.734534, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.646084, max_value=1.044035, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.028797523, 0.02150921, 0.26203299, 0.30878268, 0.5449025, 0.7673023, 1.1072539, 1.2656269, 1.2815489, 6.1960255]),
           ...
           st.floats(min_value=0.780628, max_value=1.190673, allow_nan=False),
           st.floats(min_value=5.013888, max_value=8.734534, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.044038, max_value=1.225035, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.78441482, -0.48562331, -0.48172751, 0.014225744, 0.11754934, 0.13635084, 0.14583629, 0.20766106, 0.26237175, 0.94142796]),
           ...
           st.floats(min_value=1.190676, max_value=1.229241, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.030993, max_value=3.06075, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.061709, max_value=1.563567, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.22494297, -0.19021947, -0.061657814, 0.22442997, 0.35790373, 0.36230769, 0.37433387, 0.55930005, 0.61350259, 3.7801167]),
           ...
           st.floats(min_value=1.190676, max_value=1.229241, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.179783, max_value=7.26725, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.061709, max_value=1.563567, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.51391026, -0.23764669, -0.13974335, -0.07639413, -0.025240482, -0.0093184852, 0.042173929, 0.53575582, 0.8894274, 1.1275798]),
           ...
           st.floats(min_value=1.190676, max_value=1.229241, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.030993, max_value=7.148218, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.56357, max_value=1.640661, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.45377932, 0.14041603, 0.21579144, 0.26203299, 0.27947943, 0.32131701, 0.80338086, 1.0035915, 1.7732676, 3.7801167]),
           ...
           st.floats(min_value=1.383505, max_value=3.025036, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.030993, max_value=3.047366, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.54507673, -0.5035779, -0.27118451, -0.093671189, -0.066908685, 0.50882393, 0.58013415, 0.63467545, 0.90043729, 1.1623033]),
           ...
           st.floats(min_value=1.383505, max_value=3.025036, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.112862, max_value=3.127829, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.028966906, 0.26914707, 0.27947943, 0.37551956, 0.40837985, 0.54202299, 0.60317023, 0.7156405, 3.389689, 5.079792]),
           ...
           st.floats(min_value=1.383505, max_value=1.413589, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.187701, max_value=3.476656, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.34469671, -0.2335815, -0.15702041, -0.083677596, -0.013553059, 0.11331476, 0.5299968, 0.78322429, 1.6821396, 1.8552489]),
           ...
           st.floats(min_value=1.383505, max_value=1.413589, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.632481, max_value=4.819805, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.45377932, -0.03726667, 0.37433387, 0.40126576, 0.42294678, 0.72427903, 0.74985585, 1.2837509, 1.297979, 3.389689]),
           ...
           st.floats(min_value=1.383505, max_value=1.413589, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.569108, max_value=9.17871, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([-0.34317226, 0.10891081, 0.41938974, 0.43581988, 0.7156405, 1.2049878, 1.3242334, 2.0076936, 2.0158239, 6.1960255]),
           ...
           st.floats(min_value=1.533928, max_value=3.145375, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.187701, max_value=7.273585, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.111682, max_value=1.626033, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.48257442, -0.45377932, -0.3477456, -0.23087137, -0.043872605, 0.20291834, 0.24492531, 1.1072539, 1.2815489, 1.8916663]),
           ...
           st.floats(min_value=1.533928, max_value=3.145375, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.187701, max_value=3.623147, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.626036, max_value=1.690634, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([-0.41380495, -0.28558206, -0.2345978, -0.07182079, -0.060472133, 0.063685562, 0.16192767, 0.44632162, 0.50594442, 1.3938498]),
           ...
           st.floats(min_value=1.533928, max_value=3.145375, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.364938, max_value=9.015374, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.626036, max_value=1.690634, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
