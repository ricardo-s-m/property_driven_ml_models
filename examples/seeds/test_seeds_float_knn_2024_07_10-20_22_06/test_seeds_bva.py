...
def _setup(request):
    ...
    experiment_data_path = os.path.join(pathlib.Path(__file__).parent.resolve(), 'test_seeds_bva_experiment_data.json')
...
class TestSeedsProperty:
    ...
    @given(st.floats(min_value=12.845, max_value=13.408, allow_nan=False),
           ...
           st.floats(min_value=3.0275, max_value=3.1268, allow_nan=False),
           st.sampled_from([1.313, 1.464, 2.269, 2.462, 3.136, 3.531, 3.975, 4.102, 4.185, 4.711]),
           st.floats(min_value=4.7346, max_value=4.7884, allow_nan=False))
    ...
    @given(st.floats(min_value=12.449, max_value=12.913, allow_nan=False),
           ...
           st.floats(min_value=3.1271, max_value=3.3082, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=12.916, max_value=13.014, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=12.286, max_value=12.709, allow_nan=False),
           ...
           st.floats(min_value=1.38341, max_value=1.53798, allow_nan=False),
           st.floats(min_value=4.7887, max_value=4.946, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=12.286, max_value=12.709, allow_nan=False),
           ...
           st.floats(min_value=1.53801, max_value=2.9216, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.7887, max_value=4.946, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=12.712, max_value=12.851, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.0159, max_value=3.1123, allow_nan=False),
           st.floats(min_value=3.68382, max_value=4.41349, allow_nan=False),
           st.floats(min_value=4.7887, max_value=4.946, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=12.712, max_value=12.851, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.1126, max_value=3.2966, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.68382, max_value=4.41349, allow_nan=False),
           st.floats(min_value=4.7887, max_value=4.946, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=12.712, max_value=12.851, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=4.41352, max_value=5.22201, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.7887, max_value=4.946, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=13.411, max_value=14.964, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.3836, max_value=3.5719, allow_nan=False),
           st.sampled_from([0.8551, 1.464, 2.04, 2.699, 2.823, 2.956, 3.128, 3.328, 4.185, 5.234]),
           st.floats(min_value=5.2378, max_value=5.4174, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=13.411, max_value=14.964, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=5.4514, max_value=5.5894, allow_nan=False),
           st.floats(min_value=3.3836, max_value=3.5719, allow_nan=False),
           st.sampled_from([2.068, 2.235, 2.257, 2.725, 2.858, 3.237, 3.357, 3.691, 4.675, 6.682]),
           st.floats(min_value=5.4177, max_value=5.4492, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=13.411, max_value=14.964, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=5.5897, max_value=5.8067, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.3836, max_value=3.5719, allow_nan=False),
    ...
    @given(st.floats(min_value=13.411, max_value=14.035, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=3.5722, max_value=3.6643, exclude_min=True, allow_nan=False),
           st.sampled_from([1.738, 2.188, 2.843, 2.962, 3.252, 3.357, 3.477, 3.824, 4.539, 5.532]),
           st.floats(min_value=5.3642, max_value=5.5754, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=16.536, max_value=17.464, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([11.23, 12.74, 13.84, 14.43, 14.46, 14.49, 14.7, 15.36, 16.12, 16.2]),
           ...
           st.floats(min_value=1.79622, max_value=2.05399, allow_nan=False),
           st.floats(min_value=5.5757, max_value=5.6376, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([15.99, 17.26, 18.14, 18.27, 18.81, 18.85, 18.95, 19.06, 20.03, 20.97]),
           ...
           st.floats(min_value=1.79622, max_value=2.05399, allow_nan=False),
           st.floats(min_value=5.8856, max_value=6.0184, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([15.56, 17.26, 18.14, 18.59, 18.75, 18.81, 18.85, 18.94, 18.96, 19.46]),
           ...
           st.floats(min_value=2.05402, max_value=3.33441, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.5757, max_value=5.7705, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
