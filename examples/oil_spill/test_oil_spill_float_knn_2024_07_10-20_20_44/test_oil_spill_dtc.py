...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_oil_spill_dtc_experiment_data.json')
...
class TestOilSpillProperty:
    ...
    @given(st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           ...
           st.floats(min_value=0.01, max_value=0.163, allow_nan=False),
           ...
           st.floats(min_value=2051.5, max_value=12403.079, allow_nan=False),
    ...
    @given(st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           ...
           st.floats(min_value=0.166, max_value=1.12, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           ...
           st.floats(min_value=41.0, max_value=231.58, allow_nan=False),
           ...
           st.floats(min_value=0.13, max_value=0.319, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=12403.082, max_value=23348.294, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           ...
           st.floats(min_value=231.61, max_value=901.7, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.0, max_value=3.49, allow_nan=False),
           ...
           st.floats(min_value=0.322, max_value=2.6, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.02, max_value=0.113, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=2051.5, max_value=22457.958, allow_nan=False),
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=70312.0, max_value=121562.49, allow_nan=False),
           ...
           st.floats(min_value=0.116, max_value=0.74, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=121562.51, max_value=71315000.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.02, max_value=0.499, allow_nan=False),
           st.sampled_from([47.66, 55.85, 67.87, 69.09, 75.26, 85.22, 87.65, 123.47, 126.08]),
           st.sampled_from([0.0]),
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.501, max_value=0.77, exclude_min=True, allow_nan=False),
           st.sampled_from([47.66, 55.85, 67.87, 69.09, 75.26, 85.22, 87.65, 123.47, 126.08]),
           st.sampled_from([0.0]),
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.0, max_value=336.354, allow_nan=False),
           st.floats(min_value=2.51, max_value=180.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=121562.51, max_value=71315000.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=4.82, max_value=24.273, allow_nan=False),
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=24.276, max_value=6058.23, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=5.81, max_value=7.499, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=7.501, max_value=15.44, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.92, max_value=9.939, allow_nan=False),
           st.floats(min_value=336.357, max_value=2724.57, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.51, max_value=180.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=121562.51, max_value=71315000.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=64.0, max_value=100.49, allow_nan=False),
           st.sampled_from([39.0, 50.0, 55.0, 63.0, 67.0, 69.0, 73.0, 85.0, 86.0]),
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=100.51, max_value=143.0, exclude_min=True, allow_nan=False),
           st.sampled_from([39.0, 50.0, 55.0, 63.0, 67.0, 69.0, 73.0, 85.0, 86.0]),
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=9.942, max_value=1893.08, exclude_min=True, allow_nan=False),
           st.floats(min_value=336.357, max_value=2724.57, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.51, max_value=180.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=121562.51, max_value=71315000.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=3.51, max_value=18.49, exclude_min=True, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=22457.961, max_value=23348.294, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=70312.0, max_value=74530.99, allow_nan=False),
           ...
           st.floats(min_value=360.0, max_value=764.99, allow_nan=False),
           st.sampled_from([0.0, 0.01]),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=2051.5, max_value=23348.294, allow_nan=False),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=765.01, max_value=95310.0, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0, 0.01, 0.02]),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.0, max_value=365.054, allow_nan=False),
           st.sampled_from([10.0, 25.0, 34.0, 42.0, 62.0, 112.0, 141.0, 148.0, 156.0, 161.0]),
           st.floats(min_value=74531.01, max_value=71315000.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.44, max_value=1.698, allow_nan=False),
           ...
           st.sampled_from([0.0, 0.01, 0.02]),
           st.floats(min_value=5.05, max_value=13.658, allow_nan=False),
           st.sampled_from([64.0, 78.0, 82.0, 85.0, 89.0, 99.0, 102.0, 133.0, 143.0]),
           st.sampled_from([39.0, 50.0, 55.0, 63.0, 67.0, 69.0, 73.0, 85.0, 86.0]),
           ...
           st.floats(min_value=0.0, max_value=448.713, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=2051.5, max_value=23348.294, allow_nan=False),
           st.floats(min_value=35.95, max_value=65.914, allow_nan=False),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.sampled_from([0.0, 0.01]),
           st.floats(min_value=13.661, max_value=441.23, exclude_min=True, allow_nan=False),
           st.sampled_from([64.0, 78.0, 82.0, 85.0, 89.0, 99.0, 102.0, 133.0, 143.0]),
           st.sampled_from([39.0, 50.0, 55.0, 63.0, 67.0, 69.0, 73.0, 85.0, 86.0]),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.701, max_value=39.42, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.83, max_value=9.274, allow_nan=False),
           ...
           st.floats(min_value=448.716, max_value=9593.48, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=9.277, max_value=24.69, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.0, max_value=365.054, allow_nan=False),
           st.floats(min_value=0.0, max_value=91.49, allow_nan=False),
           st.floats(min_value=74531.01, max_value=71315000.0, exclude_min=True, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=2051.5, max_value=23348.294, allow_nan=False),
           st.floats(min_value=65.917, max_value=66.45, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.0, max_value=365.054, allow_nan=False),
           st.floats(min_value=91.51, max_value=180.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=74531.01, max_value=71315000.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=365.057, max_value=365.894, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=18.51, max_value=352.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=365.897, max_value=2724.57, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([5.0, 6.0, 10.0, 13.0, 16.0, 23.0, 47.0, 118.0, 125.0, 140.0]),
           ...
           st.floats(min_value=0.0, max_value=97.49, allow_nan=False),
           ...
           st.sampled_from([-0.71, -0.53, -0.01, 0.18, 0.87, 0.97, 1.01, 1.83]),
           st.sampled_from([2.96, 3.01, 3.78, 3.83, 4.66, 5.07, 9.24, 12.06, 14.78]),
           st.floats(min_value=-1.79, max_value=-0.396, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=23348.297, max_value=55128.46, exclude_min=True, allow_nan=False),
           st.floats(min_value=35.95, max_value=65.664, allow_nan=False),
    ...
    @given(st.sampled_from([14.0, 24.0, 52.0, 79.0, 98.0, 105.0, 135.0, 163.0, 180.0, 257.0]),
           ...
           st.sampled_from([-0.71, -0.53, -0.01, 0.18, 0.87, 0.97, 1.01, 1.83]),
           st.sampled_from([2.96, 3.01, 3.78, 3.83, 4.66, 5.07, 9.24, 12.06, 14.78]),
           st.floats(min_value=-0.393, max_value=5.72, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([7.0, 31.0, 36.0, 37.0, 97.0, 109.0, 179.0, 181.0, 188.0, 192.0]),
           ...
           st.floats(min_value=0.02, max_value=0.084, allow_nan=False),
           ...
           st.sampled_from([0.0, 1.0]),
           st.floats(min_value=23348.297, max_value=55128.46, exclude_min=True, allow_nan=False),
           st.floats(min_value=65.667, max_value=66.45, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.0, 3.0, 4.0, 16.0, 18.0, 28.0, 47.0, 118.0, 125.0, 140.0]),
           ...
           st.floats(min_value=0.087, max_value=0.65, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([4.0, 7.0, 10.0, 11.0, 16.0, 17.0, 23.0, 47.0, 72.0, 125.0]),
           ...
           st.floats(min_value=97.51, max_value=180.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=70312.0, max_value=88677.99, allow_nan=False),
           ...
           st.floats(min_value=41.0, max_value=146.64, allow_nan=False),
    ...
    @given(st.sampled_from([44.0, 52.0, 62.0, 122.0, 123.0, 131.0, 140.0, 169.0, 180.0, 190.0]),
           ...
           st.floats(min_value=97.51, max_value=180.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=88678.01, max_value=71315000.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([42.0, 67.0, 98.0, 109.0, 120.0, 133.0, 146.0, 147.0, 185.0, 197.0]),
           ...
           st.floats(min_value=146.67, max_value=901.7, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.01, max_value=0.079, allow_nan=False),
    ...
    @given(st.sampled_from([2.0, 3.0, 6.0, 7.0, 9.0, 13.0, 16.0, 18.0, 28.0, 140.0]),
           ...
           st.floats(min_value=0.082, max_value=0.65, exclude_min=True, allow_nan=False),
