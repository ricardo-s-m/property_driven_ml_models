...
def _setup(request):
    ...
    experiment_data_path = os.path.join(pathlib.Path(__file__).parent.resolve(), 'test_iris_dtc_experiment_data.json')
...
class TestIrisProperty:
    ...
    @given(st.sampled_from([4.5, 4.7, 4.8, 4.9, 5.0, 5.1, 5.3, 5.5, 5.7, 5.8]),
           ...
           st.floats(min_value=1.0, max_value=2.43, allow_nan=False),
    ...
    @given(st.sampled_from([4.9, 5.0, 5.2, 5.5, 5.6, 6.3, 6.4, 6.5, 6.7, 6.9]),
           ...
           st.floats(min_value=2.46, max_value=4.94, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.1, max_value=1.64, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([5.8, 6.0, 6.1, 6.2, 6.4, 6.5, 6.9, 7.4, 7.6, 7.7]),
           ...
           st.floats(min_value=2.46, max_value=4.94, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.67, max_value=1.74, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([5.7, 5.9, 6.0, 6.1, 6.2, 6.3, 6.8, 7.1, 7.3, 7.7]),
           ...
           st.floats(min_value=4.97, max_value=6.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.1, max_value=1.54, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([4.9, 5.0, 5.2, 5.5, 5.6, 5.7, 5.8, 6.1, 6.2, 6.4]),
           ...
           st.floats(min_value=4.97, max_value=5.44, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.57, max_value=1.74, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([5.6, 5.9, 6.0, 6.1, 6.2, 6.3, 6.7, 7.2, 7.7, 7.9]),
           ...
           st.floats(min_value=5.47, max_value=6.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.57, max_value=1.74, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=4.3, max_value=5.94, allow_nan=False),
           st.sampled_from([2.3, 2.5, 2.6, 2.8, 2.9, 3.0, 3.1, 3.2, 3.3, 3.4]),
           st.floats(min_value=2.46, max_value=4.84, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.76, max_value=2.5, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=5.97, max_value=7.9, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([4.9, 5.6, 6.2, 6.4, 6.7, 6.8, 7.1, 7.4, 7.6, 7.7]),
           ...
           st.floats(min_value=4.87, max_value=6.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.76, max_value=2.5, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
