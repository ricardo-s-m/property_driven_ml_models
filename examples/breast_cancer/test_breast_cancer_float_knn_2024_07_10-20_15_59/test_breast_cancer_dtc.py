...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_breast_cancer_dtc_experiment_data.json')
...
class TestBreastCancerProperty:
    ...
    @given(st.sampled_from([10.05, 11.46, 11.67, 12.03, 12.16, 12.36, 12.87, 13.03, 13.05, 14.5]),
           ...
           st.floats(min_value=6.802, max_value=38.6048, allow_nan=False),
           st.floats(min_value=0.001713, max_value=0.003293, allow_nan=False),
           ...
           st.floats(min_value=7.93, max_value=16.7949, allow_nan=False),
           st.floats(min_value=12.02, max_value=27.754, allow_nan=False),
           ...
           st.floats(min_value=0.0, max_value=0.135799, allow_nan=False),
    ...
    @given(st.sampled_from([11.42, 14.48, 15.46, 16.02, 16.27, 17.27, 18.46, 18.82, 21.56, 22.27]),
           ...
           st.floats(min_value=7.93, max_value=16.7949, allow_nan=False),
           st.floats(min_value=27.757, max_value=49.54, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([8.95, 9.295, 10.48, 10.57, 10.9, 11.69, 12.04, 13.56, 14.95, 16.17]),
           ...
           st.floats(min_value=6.802, max_value=38.6048, allow_nan=False),
           st.floats(min_value=0.003296, max_value=0.03113, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=7.93, max_value=16.7949, allow_nan=False),
           st.floats(min_value=12.02, max_value=33.268, allow_nan=False),
    ...
    @given(st.sampled_from([11.8, 15.06, 17.35, 18.82, 19.07, 19.19, 19.68, 20.58, 20.92, 25.22]),
           ...
           st.floats(min_value=7.93, max_value=16.7949, allow_nan=False),
           st.floats(min_value=33.271, max_value=33.558, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([8.726, 10.26, 10.32, 11.04, 11.7, 11.74, 12.25, 12.77, 12.95, 13.46]),
           ...
           st.floats(min_value=7.93, max_value=16.7949, allow_nan=False),
           st.floats(min_value=33.561, max_value=49.54, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([13.4, 13.98, 14.27, 15.13, 15.46, 16.26, 16.74, 19.0, 19.53, 20.64]),
           ...
           st.floats(min_value=0.01938, max_value=0.059568, allow_nan=False),
           ...
           st.floats(min_value=38.6051, max_value=91.5549, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.0, max_value=0.328399, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.135799, allow_nan=False),
    ...
    @given(st.sampled_from([8.878, 9.667, 12.16, 12.23, 12.94, 13.34, 13.56, 13.87, 14.29, 16.5]),
           ...
           st.floats(min_value=0.059571, max_value=0.3454, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([13.17, 13.86, 15.12, 19.27, 19.73, 20.2, 21.16, 23.09, 23.27, 23.29]),
           ...
           st.floats(min_value=0.328402, max_value=1.252, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0, max_value=0.135799, allow_nan=False),
    ...
    @given(st.sampled_from([12.83, 13.0, 16.02, 16.07, 18.82, 19.1, 20.44, 21.37, 21.71, 23.27]),
           ...
           st.floats(min_value=91.5552, max_value=542.2, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([8.95, 9.742, 9.777, 11.16, 12.34, 14.41, 14.42, 14.44, 14.96, 15.04]),
           ...
           st.floats(min_value=7.93, max_value=16.7949, allow_nan=False),
           st.floats(min_value=12.02, max_value=25.669, allow_nan=False),
           st.sampled_from([68.73, 76.25, 77.98, 78.28, 84.35, 86.04, 86.6, 88.54, 95.78, 102.8]),
           st.floats(min_value=185.2, max_value=810.29, allow_nan=False),
           st.floats(min_value=0.07117, max_value=0.178549, allow_nan=False),
           ...
           st.floats(min_value=0.135802, max_value=0.291, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([10.95, 13.0, 14.45, 15.13, 16.35, 16.65, 18.63, 20.26, 21.61, 27.42]),
           ...
           st.floats(min_value=185.2, max_value=810.29, allow_nan=False),
           st.floats(min_value=0.178552, max_value=0.2226, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([9.567, 9.742, 10.05, 10.94, 11.5, 12.56, 12.58, 13.14, 13.74, 14.62]),
           ...
           st.floats(min_value=0.01938, max_value=0.120899, allow_nan=False),
           ...
           st.floats(min_value=810.32, max_value=4254.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([11.8, 14.68, 14.95, 15.08, 17.46, 17.6, 19.53, 19.59, 20.09, 20.26]),
           ...
           st.floats(min_value=0.120902, max_value=0.3454, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([9.295, 9.742, 10.25, 10.82, 11.61, 11.84, 13.11, 13.24, 13.54, 15.0]),
           st.floats(min_value=9.71, max_value=20.453, allow_nan=False),
           ...
           st.floats(min_value=0.0, max_value=0.054098, allow_nan=False),
           ...
           st.floats(min_value=7.93, max_value=16.7949, allow_nan=False),
           st.floats(min_value=25.672, max_value=49.54, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([13.44, 14.86, 14.87, 19.1, 19.4, 20.18, 21.56, 22.27, 23.27, 24.63]),
           st.floats(min_value=20.456, max_value=39.28, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([12.46, 15.3, 15.53, 15.85, 16.25, 18.65, 18.94, 20.13, 20.55, 28.11]),
           ...
           st.floats(min_value=0.054101, max_value=0.2012, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([9.606, 11.6, 12.05, 12.34, 12.56, 13.45, 13.7, 13.74, 14.8, 16.3]),
           ...
           st.floats(min_value=0.0, max_value=0.033714, allow_nan=False),
           ...
           st.floats(min_value=16.7952, max_value=36.04, exclude_min=True, allow_nan=False),
           st.floats(min_value=12.02, max_value=19.908, allow_nan=False),
    ...
    @given(st.sampled_from([11.84, 12.68, 15.32, 15.46, 16.03, 16.11, 17.42, 17.68, 18.66, 21.16]),
           ...
           st.floats(min_value=0.033717, max_value=0.396, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([8.726, 9.042, 9.295, 12.43, 13.11, 13.45, 13.56, 13.62, 14.87, 16.14]),
           ...
           st.floats(min_value=16.7952, max_value=36.04, exclude_min=True, allow_nan=False),
           st.floats(min_value=19.911, max_value=49.54, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.07117, max_value=0.087978, allow_nan=False),
    ...
    @given(st.sampled_from([13.81, 15.05, 15.66, 16.26, 17.3, 18.61, 20.47, 20.94, 24.25, 25.73]),
           ...
           st.floats(min_value=0.05263, max_value=0.091739, allow_nan=False),
           ...
           st.floats(min_value=0.087981, max_value=0.2226, exclude_min=True, allow_nan=False),
           st.sampled_from([0.205, 0.2053, 0.2534, 0.2536, 0.3559, 0.3682, 0.4503, 0.4706, 0.5634, 0.8681]),
           st.floats(min_value=0.0, max_value=0.179749, allow_nan=False),
    ...
    @given(st.sampled_from([11.61, 12.76, 12.87, 13.17, 13.45, 13.87, 13.94, 14.5, 14.62, 14.8]),
           ...
           st.floats(min_value=0.091742, max_value=0.1634, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([13.4, 14.71, 15.75, 17.08, 17.54, 18.03, 18.45, 18.63, 19.21, 23.21]),
           ...
           st.floats(min_value=0.179752, max_value=1.252, exclude_min=True, allow_nan=False),
