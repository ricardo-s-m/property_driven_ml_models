...
def _setup(request):
    ...
    experiment_data_path = os.path.join(pathlib.Path(__file__).parent.resolve(), 'test_sonar_dtc_experiment_data.json')
...
class TestSonarProperty:
    ...
    @given(st.floats(min_value=0.0015, max_value=0.03924, allow_nan=False),
           st.sampled_from([0.0065, 0.0165, 0.022, 0.0279, 0.0308, 0.0324, 0.0363, 0.0478, 0.0707, 0.0849]),
           st.floats(min_value=0.0015, max_value=0.00194, allow_nan=False),
           st.floats(min_value=0.0058, max_value=0.05149, allow_nan=False),
           ...
           st.floats(min_value=0.0289, max_value=0.19793, allow_nan=False),
           ...
           st.floats(min_value=0.0284, max_value=0.99069, allow_nan=False),
    ...
    @given(st.floats(min_value=0.0015, max_value=0.03924, allow_nan=False),
           ...
           st.floats(min_value=0.00197, max_value=0.3059, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.0058, max_value=0.05149, allow_nan=False),
           ...
           st.floats(min_value=0.0, max_value=0.02959, allow_nan=False),
    ...
    @given(st.floats(min_value=0.0015, max_value=0.03924, allow_nan=False),
           ...
           st.floats(min_value=0.0284, max_value=0.07148, allow_nan=False),
           ...
           st.floats(min_value=0.02962, max_value=0.7762, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.0015, max_value=0.03924, allow_nan=False),
           ...
           st.floats(min_value=0.07151, max_value=0.99069, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.03927, max_value=0.1371, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0056, 0.0197, 0.0211, 0.0249, 0.0261, 0.027, 0.0368, 0.0374, 0.0394, 0.115]),
           ...
           st.floats(min_value=0.99072, max_value=1.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0089, 0.0163, 0.018, 0.026, 0.0261, 0.0294, 0.0299, 0.0346, 0.0392, 0.1088]),
           ...
           st.floats(min_value=0.05152, max_value=0.4264, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.0075, max_value=0.05583, allow_nan=False),
           ...
           st.floats(min_value=0.0, max_value=0.16154, allow_nan=False),
    ...
    @given(st.sampled_from([0.0108, 0.0125, 0.013, 0.019, 0.0192, 0.0286, 0.0408, 0.0409, 0.0453, 0.0664]),
           ...
           st.floats(min_value=0.05586, max_value=0.6828, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.013, 0.0158, 0.0164, 0.0269, 0.0299, 0.0307, 0.0363, 0.0411, 0.0522, 0.1083]),
           ...
           st.floats(min_value=0.16157, max_value=0.7034, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0091, 0.0108, 0.0123, 0.0188, 0.0202, 0.0211, 0.0217, 0.0223, 0.0262, 0.0378]),
           ...
           st.floats(min_value=0.0058, max_value=0.06908, allow_nan=False),
           ...
           st.floats(min_value=0.19796, max_value=0.7342, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.0162, max_value=0.66654, allow_nan=False),
           ...
           st.floats(min_value=0.0212, max_value=0.69213, allow_nan=False),
           ...
           st.floats(min_value=0.0008, max_value=0.00389, allow_nan=False),
    ...
    @given(st.sampled_from([0.0056, 0.0163, 0.0269, 0.027, 0.0315, 0.0428, 0.0443, 0.0516, 0.0526, 0.0731]),
           ...
           st.floats(min_value=0.06911, max_value=0.4264, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0108, 0.0124, 0.02, 0.0202, 0.0208, 0.0216, 0.0231, 0.026, 0.0336, 0.0442]),
           ...
           st.floats(min_value=0.0075, max_value=0.41994, allow_nan=False),
           ...
           st.floats(min_value=0.0375, max_value=0.13074, allow_nan=False),
           ...
           st.floats(min_value=0.00392, max_value=0.0709, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0089, 0.0107, 0.0131, 0.0197, 0.0235, 0.0261, 0.031, 0.0423, 0.0522, 0.0731]),
           ...
           st.floats(min_value=0.41997, max_value=0.6828, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0115, 0.0131, 0.0176, 0.0181, 0.024, 0.026, 0.027, 0.0286, 0.0365, 0.0368]),
           ...
           st.floats(min_value=0.13077, max_value=1.0, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.0284, max_value=0.21473, allow_nan=False),
    ...
    @given(st.sampled_from([0.0072, 0.0156, 0.0197, 0.0258, 0.0264, 0.027, 0.0443, 0.053, 0.0654, 0.115]),
           ...
           st.floats(min_value=0.21476, max_value=1.0, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0068, 0.0126, 0.0139, 0.0164, 0.0181, 0.0208, 0.0211, 0.0298, 0.0368, 0.0762]),
           ...
           st.floats(min_value=0.0162, max_value=0.59994, allow_nan=False),
           ...
           st.floats(min_value=0.69216, max_value=0.9647, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.0, max_value=0.06708, allow_nan=False),
    ...
    @given(st.sampled_from([0.0072, 0.0095, 0.0156, 0.0201, 0.0283, 0.0305, 0.0491, 0.0707, 0.0715, 0.1088]),
           ...
           st.floats(min_value=0.59997, max_value=0.66654, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0156, 0.0228, 0.0231, 0.0238, 0.0283, 0.043, 0.0587, 0.0629, 0.0712, 0.0731]),
           ...
           st.floats(min_value=0.06711, max_value=0.1981, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0065, 0.0132, 0.0164, 0.019, 0.0195, 0.0206, 0.0274, 0.0442, 0.0459, 0.0519]),
           ...
           st.floats(min_value=0.0031, max_value=0.52223, allow_nan=False),
           st.floats(min_value=0.66657, max_value=0.9988, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.0482, max_value=0.39979, allow_nan=False),
    ...
    @given(st.sampled_from([0.0191, 0.0264, 0.0272, 0.0283, 0.031, 0.0388, 0.0587, 0.0654, 0.0712, 0.1021]),
           ...
           st.floats(min_value=0.0075, max_value=0.33254, allow_nan=False),
           ...
           st.floats(min_value=0.52226, max_value=1.0, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.66657, max_value=0.9988, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0071, 0.0091, 0.0164, 0.0188, 0.02, 0.0217, 0.026, 0.0274, 0.0311, 0.0473]),
           ...
           st.floats(min_value=0.33257, max_value=0.6828, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0087, 0.0108, 0.0109, 0.0176, 0.0195, 0.0208, 0.0274, 0.0286, 0.0311, 0.0352]),
           ...
           st.floats(min_value=0.39982, max_value=0.9657, exclude_min=True, allow_nan=False),
