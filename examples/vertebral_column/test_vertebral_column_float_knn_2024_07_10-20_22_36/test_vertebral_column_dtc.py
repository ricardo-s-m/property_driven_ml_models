...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_vertebral_column_dtc_experiment_data.json')
...
class TestVertebralColumnProperty:
    ...
    @given(st.sampled_from([26.15, 31.48, 35.7, 38.66, 40.56, 41.17, 41.73, 44.32, 46.39, 48.11]),
           st.floats(min_value=-6.55, max_value=16.393, allow_nan=False),
           st.floats(min_value=14.0, max_value=17.913, allow_nan=False),
           st.floats(min_value=13.37, max_value=28.133, allow_nan=False),
           st.floats(min_value=70.08, max_value=139.973, allow_nan=False),
           st.floats(min_value=-11.06, max_value=0.339, allow_nan=False))
    ...
    @given(st.sampled_from([34.65, 35.88, 37.14, 41.65, 44.43, 46.37, 48.8, 49.83, 51.62, 53.91]),
           st.floats(min_value=-6.55, max_value=16.393, allow_nan=False),
           st.floats(min_value=17.916, max_value=125.74, exclude_min=True, allow_nan=False),
           st.floats(min_value=13.37, max_value=28.133, allow_nan=False),
           st.floats(min_value=70.08, max_value=139.973, allow_nan=False),
           st.floats(min_value=-11.06, max_value=0.339, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([26.15, 39.06, 41.35, 41.73, 53.43, 53.85, 54.92, 56.03, 68.83, 74.43]),
           st.floats(min_value=16.396, max_value=49.43, exclude_min=True, allow_nan=False),
           st.sampled_from([30.12, 30.71, 31.33, 32.14, 33.47, 35.0, 36.18, 40.26, 47.5, 50.09]),
           st.floats(min_value=13.37, max_value=28.133, allow_nan=False),
           st.floats(min_value=70.08, max_value=139.973, allow_nan=False),
           st.floats(min_value=-11.06, max_value=-0.911, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([41.65, 43.44, 44.36, 51.31, 51.62, 67.29, 67.54, 72.96, 74.98, 89.83]),
           ...
           st.floats(min_value=13.37, max_value=28.133, allow_nan=False),
           st.floats(min_value=70.08, max_value=125.658, allow_nan=False),
           st.floats(min_value=-0.908, max_value=0.339, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([31.28, 39.06, 41.35, 43.58, 46.44, 47.66, 50.21, 63.83, 66.29, 66.88]),
           ...
           st.floats(min_value=13.37, max_value=28.133, allow_nan=False),
           st.floats(min_value=125.661, max_value=139.973, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.908, max_value=0.339, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([36.13, 40.25, 43.58, 44.32, 46.44, 48.33, 49.71, 66.29, 69.3, 74.43]),
           ...
           st.floats(min_value=13.37, max_value=28.133, allow_nan=False),
           st.floats(min_value=70.08, max_value=115.314, allow_nan=False),
           st.floats(min_value=0.342, max_value=6.923, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([34.65, 34.76, 38.13, 47.32, 51.08, 51.62, 53.91, 59.73, 62.14, 63.93]),
           ...
           st.floats(min_value=13.37, max_value=28.133, allow_nan=False),
           st.floats(min_value=115.317, max_value=117.089, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.342, max_value=6.923, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([30.15, 31.23, 32.09, 36.13, 36.69, 40.56, 43.35, 44.94, 47.66, 66.29]),
           ...
           st.floats(min_value=13.37, max_value=28.133, allow_nan=False),
           st.floats(min_value=117.092, max_value=139.973, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.342, max_value=6.923, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([30.74, 39.09, 40.75, 44.43, 51.33, 53.68, 56.45, 63.03, 63.96, 67.29]),
           ...
           st.floats(min_value=13.37, max_value=28.133, allow_nan=False),
           st.floats(min_value=139.976, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=6.923, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([38.13, 38.51, 40.68, 42.52, 46.64, 47.32, 54.92, 63.79, 65.61, 67.29]),
           ...
           st.floats(min_value=6.926, max_value=8.488, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([30.15, 31.28, 41.35, 41.73, 47.66, 48.11, 50.21, 55.29, 63.03, 66.29]),
           ...
           st.floats(min_value=8.491, max_value=16.078, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([30.15, 31.48, 35.49, 38.66, 41.77, 48.33, 48.92, 50.82, 50.91, 68.83]),
           st.floats(min_value=-6.55, max_value=25.488, allow_nan=False),
           st.sampled_from([20.7, 24.28, 25.02, 28.32, 30.12, 35.56, 40.26, 41.95, 42.69, 47.0]),
           st.floats(min_value=28.136, max_value=46.644, exclude_min=True, allow_nan=False),
           st.floats(min_value=70.08, max_value=112.923, allow_nan=False),
           st.floats(min_value=-11.06, max_value=16.078, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([33.04, 37.73, 38.05, 39.36, 41.65, 43.44, 46.24, 46.37, 51.08, 66.51]),
           st.floats(min_value=25.491, max_value=49.43, exclude_min=True, allow_nan=False),
           st.sampled_from([19.07, 29.36, 29.5, 36.03, 37.0, 37.97, 43.58, 51.87, 66.0, 90.56]),
           st.floats(min_value=28.136, max_value=46.644, exclude_min=True, allow_nan=False),
           st.floats(min_value=70.08, max_value=107.063, allow_nan=False),
           st.floats(min_value=-11.06, max_value=16.078, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([41.77, 43.79, 44.55, 44.94, 45.37, 48.33, 53.57, 54.12, 56.03, 74.43]),
           ...
           st.floats(min_value=28.136, max_value=46.644, exclude_min=True, allow_nan=False),
           st.floats(min_value=107.066, max_value=112.923, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=16.078, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([37.73, 38.51, 42.92, 44.43, 45.25, 45.58, 48.17, 51.33, 63.93, 65.76]),
           ...
           st.floats(min_value=28.136, max_value=35.268, exclude_min=True, allow_nan=False),
           st.floats(min_value=112.926, max_value=114.389, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=16.078, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([33.84, 43.12, 50.68, 50.91, 54.92, 54.95, 56.45, 62.14, 63.93, 64.31]),
           st.floats(min_value=-6.55, max_value=9.449, allow_nan=False),
           st.sampled_from([20.24, 28.0, 34.46, 36.67, 40.0, 43.46, 43.58, 44.0, 49.35, 55.34]),
           st.floats(min_value=28.136, max_value=35.268, exclude_min=True, allow_nan=False),
           st.floats(min_value=114.392, max_value=117.358, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=16.078, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([31.28, 35.7, 36.13, 38.66, 43.58, 43.79, 45.37, 49.71, 53.85, 54.92]),
           st.floats(min_value=9.452, max_value=49.43, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([31.48, 32.09, 35.7, 36.69, 41.17, 43.79, 44.32, 48.33, 50.91, 56.03]),
           ...
           st.floats(min_value=35.271, max_value=42.974, exclude_min=True, allow_nan=False),
           st.floats(min_value=112.926, max_value=117.358, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=2.393, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([37.14, 39.36, 43.12, 46.24, 50.75, 51.33, 56.45, 61.45, 64.26, 67.8]),
           ...
           st.floats(min_value=42.977, max_value=46.644, exclude_min=True, allow_nan=False),
           st.floats(min_value=112.926, max_value=117.358, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=2.393, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=26.15, max_value=64.019, allow_nan=False),
           ...
           st.floats(min_value=35.271, max_value=46.644, exclude_min=True, allow_nan=False),
           st.floats(min_value=112.926, max_value=117.358, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.396, max_value=16.078, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=64.022, max_value=129.83, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([34.65, 39.09, 44.36, 48.17, 48.9, 53.68, 56.45, 63.79, 63.93, 67.54]),
           ...
           st.floats(min_value=46.647, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=70.08, max_value=112.999, allow_nan=False),
           st.floats(min_value=-11.06, max_value=9.073, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([57.04, 57.29, 60.04, 60.42, 63.77, 69.76, 71.24, 72.22, 81.66, 86.04]),
           ...
           st.floats(min_value=46.647, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=113.001, max_value=114.798, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=9.073, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([41.65, 45.58, 50.09, 50.75, 53.94, 54.75, 54.92, 61.82, 66.51, 69.0]),
           ...
           st.floats(min_value=46.647, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=114.801, max_value=117.358, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=9.073, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([41.19, 52.2, 65.54, 73.64, 76.33, 77.66, 80.43, 81.08, 85.58, 89.68]),
           ...
           st.floats(min_value=46.647, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=70.08, max_value=117.358, allow_nan=False),
           st.floats(min_value=9.076, max_value=16.078, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([31.28, 38.66, 41.35, 44.32, 45.37, 47.66, 48.33, 54.92, 55.84, 66.29]),
           st.floats(min_value=-6.55, max_value=24.733, allow_nan=False),
           st.sampled_from([15.5, 20.03, 20.7, 26.79, 31.33, 32.14, 33.1, 36.18, 37.17, 47.0]),
           st.floats(min_value=28.136, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=117.361, max_value=118.064, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=-4.621, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([34.38, 36.42, 38.13, 38.51, 40.35, 46.37, 50.91, 51.62, 61.45, 69.0]),
           ...
           st.floats(min_value=28.136, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=117.361, max_value=118.064, exclude_min=True, allow_nan=False),
           st.floats(min_value=-4.618, max_value=5.199, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([36.42, 42.52, 46.37, 46.64, 49.83, 51.53, 64.26, 65.76, 66.51, 89.01]),
           st.floats(min_value=-6.55, max_value=20.978, allow_nan=False),
           st.sampled_from([25.32, 31.73, 33.26, 37.97, 43.0, 48.0, 58.25, 61.01, 69.02, 90.56]),
           st.floats(min_value=28.136, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=118.067, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=5.199, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([33.84, 35.88, 40.35, 43.12, 46.64, 47.32, 48.8, 50.09, 52.86, 63.03]),
           st.floats(min_value=20.981, max_value=24.733, exclude_min=True, allow_nan=False),
           st.sampled_from([25.32, 28.94, 32.24, 32.39, 33.63, 36.0, 40.35, 51.61, 54.0, 55.5]),
           st.floats(min_value=28.136, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=118.067, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=0.479, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([40.25, 43.35, 44.32, 44.55, 45.54, 46.39, 48.11, 48.92, 50.91, 54.12]),
           ...
           st.floats(min_value=28.136, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=118.067, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.482, max_value=5.199, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([26.15, 31.28, 38.66, 39.06, 41.73, 43.2, 43.35, 48.11, 50.21, 68.83]),
           st.floats(min_value=24.736, max_value=49.43, exclude_min=True, allow_nan=False),
           st.sampled_from([20.03, 20.7, 27.78, 28.32, 29.0, 35.33, 35.56, 42.2, 47.69, 54.0]),
           st.floats(min_value=28.136, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=117.361, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=-11.06, max_value=5.199, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([35.49, 36.13, 40.25, 41.17, 43.2, 43.58, 43.79, 54.12, 63.07, 74.43]),
           ...
           st.floats(min_value=28.136, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=117.361, max_value=128.114, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.202, max_value=8.133, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([31.48, 32.09, 35.49, 38.66, 40.56, 43.2, 43.92, 63.07, 63.83, 74.43]),
           ...
           st.floats(min_value=28.136, max_value=30.653, exclude_min=True, allow_nan=False),
           st.floats(min_value=128.117, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.202, max_value=8.133, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([39.09, 40.35, 42.92, 45.08, 46.64, 49.0, 51.08, 53.68, 59.73, 63.79]),
           ...
           st.floats(min_value=30.656, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=128.117, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.202, max_value=8.133, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=26.15, max_value=40.759, allow_nan=False),
           st.sampled_from([1.84, 8.57, 9.98, 11.94, 13.88, 14.5, 16.49, 16.93, 19.44, 26.08]),
           st.floats(min_value=14.0, max_value=74.478, allow_nan=False),
           st.floats(min_value=28.136, max_value=30.519, exclude_min=True, allow_nan=False),
           st.floats(min_value=117.361, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.136, max_value=16.078, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=40.762, max_value=129.83, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([33.79, 39.66, 40.41, 41.65, 42.52, 50.68, 51.53, 59.17, 62.14, 63.96]),
           ...
           st.floats(min_value=14.0, max_value=74.478, allow_nan=False),
           st.floats(min_value=30.522, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=117.361, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.136, max_value=16.078, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([53.94, 60.63, 63.36, 65.67, 66.8, 73.64, 75.3, 85.64, 90.51, 118.14]),
           ...
           st.floats(min_value=74.481, max_value=125.74, exclude_min=True, allow_nan=False),
           st.floats(min_value=28.136, max_value=121.43, exclude_min=True, allow_nan=False),
           st.floats(min_value=117.361, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=8.136, max_value=16.078, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=26.15, max_value=57.219, allow_nan=False),
           ...
           st.floats(min_value=16.081, max_value=20.084, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=57.222, max_value=129.83, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([50.83, 55.51, 58.78, 60.63, 74.38, 77.41, 79.94, 85.29, 87.68, 94.17]),
           ...
           st.floats(min_value=70.08, max_value=121.743, allow_nan=False),
           st.floats(min_value=20.087, max_value=30.889, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([34.38, 40.41, 41.65, 44.36, 51.33, 54.95, 59.17, 67.54, 69.0, 69.4]),
           ...
           st.floats(min_value=121.746, max_value=124.013, exclude_min=True, allow_nan=False),
           st.floats(min_value=20.087, max_value=30.889, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([47.74, 50.83, 56.56, 69.76, 71.19, 74.85, 77.12, 79.25, 85.64, 95.38]),
           ...
           st.floats(min_value=124.016, max_value=163.07, exclude_min=True, allow_nan=False),
           st.floats(min_value=20.087, max_value=30.889, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([30.74, 42.52, 48.17, 48.8, 51.31, 53.94, 59.73, 61.82, 63.03, 64.31]),
           ...
           st.floats(min_value=30.892, max_value=31.249, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([48.26, 58.6, 60.75, 63.36, 64.81, 70.25, 70.95, 77.24, 77.69, 85.35]),
           ...
           st.floats(min_value=31.251, max_value=418.54, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
