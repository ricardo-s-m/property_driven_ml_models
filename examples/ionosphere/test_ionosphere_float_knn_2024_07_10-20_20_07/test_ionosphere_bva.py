...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_ionosphere_bva_experiment_data.json')
...
class TestIonosphereProperty:
    ...
    @given(st.sampled_from([0.0, 1.0]),
           ...
           st.floats(min_value=-0.166849, max_value=0.041438, allow_nan=False),
    ...
    @given(st.sampled_from([0.0, 1.0]),
           ...
           st.floats(min_value=0.041441, max_value=0.07946, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=-0.053008, max_value=0.183739, allow_nan=False),
    ...
    @given(st.sampled_from([1.0]),
           ...
           st.floats(min_value=0.183742, max_value=0.346993, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.414199, max_value=0.767748, allow_nan=False),
    ...
    @given(st.sampled_from([0.0, 1.0]),
           ...
           st.floats(min_value=0.767751, max_value=0.8142, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.0]),
           ...
           st.floats(min_value=0.231542, max_value=0.385233, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=-0.917353, max_value=-0.896692, allow_nan=False),
           ...
           st.floats(min_value=0.599956, max_value=0.999944, allow_nan=False),
           st.floats(min_value=-0.585549, max_value=-0.481937, allow_nan=False),
    ...
    @given(st.sampled_from([0.0, 1.0]),
           ...
           st.floats(min_value=0.599956, max_value=0.999944, allow_nan=False),
           st.floats(min_value=-0.481934, max_value=-0.185548, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0]),
           st.floats(min_value=0.385, max_value=0.731249, allow_nan=False),
           ...
           st.floats(min_value=0.540488, max_value=0.925609, allow_nan=False),
           st.floats(min_value=-0.896689, max_value=-0.517352, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=-0.063177, max_value=0.171028, allow_nan=False),
           ...
           st.floats(min_value=0.599956, max_value=0.999944, allow_nan=False),
           st.floats(min_value=-0.391513, max_value=-0.239392, allow_nan=False),
    ...
    @given(st.sampled_from([1.0]),
           ...
           st.floats(min_value=0.599956, max_value=0.999944, allow_nan=False),
           st.floats(min_value=-0.239389, max_value=0.008488, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0, 1.0]),
           ...
           st.floats(min_value=0.925612, max_value=0.940489, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.896689, max_value=-0.517352, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.0]),
           ...
           st.floats(min_value=0.231542, max_value=0.385233, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.014408, max_value=0.231989, allow_nan=False),
           ...
           st.floats(min_value=0.171031, max_value=0.336824, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=-0.157837, max_value=0.052703, allow_nan=False),
    ...
    @given(st.sampled_from([0.0, 1.0]),
           ...
           st.floats(min_value=0.052706, max_value=0.242164, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.0]),
           ...
           st.floats(min_value=0.231542, max_value=0.385233, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.231992, max_value=0.385593, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0]),
           st.floats(min_value=0.731252, max_value=0.785001, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=-0.804684, max_value=-0.755856, allow_nan=False),
    ...
    @given(st.sampled_from([0.0, 1.0]),
           st.sampled_from([0.0]),
           st.floats(min_value=0.731252, max_value=0.785001, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.317573, max_value=-0.146967, allow_nan=False),
           st.floats(min_value=0.231542, max_value=0.385233, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=-0.755853, max_value=-0.404683, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.008415, max_value=0.260518, allow_nan=False),
    ...
    @given(st.sampled_from([1.0]),
           ...
           st.floats(min_value=0.260521, max_value=0.408416, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([1.0]),
           st.sampled_from([0.0]),
           st.floats(min_value=0.731252, max_value=0.785001, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.146964, max_value=0.082428, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.231542, max_value=0.385233, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.4, max_value=0.49, allow_nan=False),
           ...
           st.floats(min_value=0.999947, max_value=0.999957, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.51, max_value=0.6, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0]),
           ...
           st.floats(min_value=-0.369657, max_value=-0.212072, allow_nan=False),
    ...
    @given(st.floats(min_value=0.51, max_value=0.6, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=0.431276, max_value=0.789094, allow_nan=False),
           ...
           st.floats(min_value=-0.212069, max_value=0.030344, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.51, max_value=0.6, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=-0.744048, max_value=-0.680061, allow_nan=False),
           st.floats(min_value=0.231542, max_value=0.385233, exclude_min=True, allow_nan=False),
           st.sampled_from([-0.80553, -0.36156, -0.2381, -0.23067, 0.0, 0.15033, 0.26131, 0.3913, 0.82857, 1.0]),
           st.floats(min_value=0.789097, max_value=0.831277, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.51, max_value=0.6, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0]),
           st.floats(min_value=0.488639, max_value=0.860798, allow_nan=False),
           st.floats(min_value=-0.680058, max_value=-0.344047, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.231542, max_value=0.385233, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=-0.227889, max_value=-0.034862, allow_nan=False),
    ...
    @given(st.floats(min_value=0.51, max_value=0.6, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=-0.034859, max_value=0.172112, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.51, max_value=0.6, exclude_min=True, allow_nan=False),
           st.sampled_from([0.0]),
           st.floats(min_value=0.860801, max_value=0.88864, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.680058, max_value=-0.344047, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.231542, max_value=0.385233, exclude_min=True, allow_nan=False),
