...
def _setup(request):
    ...
    experiment_data_path = os.path.join(
        ...
        'test_banknote_authentication_bva_experiment_data.json')
...
class TestDataBankNoteAuthenticationProperty:
    ...
    @given(st.floats(min_value=-1.7309, max_value=-0.403101, allow_nan=False),
           st.floats(min_value=3.079899, max_value=7.293148, allow_nan=False),
           st.floats(min_value=3.917699, max_value=6.218648, allow_nan=False),
    ...
    @given(st.floats(min_value=-1.7309, max_value=-0.403101, allow_nan=False),
           st.floats(min_value=7.293151, max_value=7.34758, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.859009, max_value=0.247763, allow_nan=False),
    ...
    @given(st.floats(min_value=-1.7309, max_value=-0.403101, allow_nan=False),
           st.floats(min_value=7.293151, max_value=7.34758, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.247766, max_value=1.441942, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=-1.7309, max_value=-0.403101, allow_nan=False),
           st.floats(min_value=-6.494221, max_value=-4.674502, allow_nan=False),
           st.floats(min_value=6.218651, max_value=8.5604, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=-3.102101, max_value=-2.117102, allow_nan=False),
           st.floats(min_value=-4.674499, max_value=-4.01792, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.218651, max_value=8.5604, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=-3.102101, max_value=-2.117102, allow_nan=False),
           st.floats(min_value=-1.391599, max_value=0.39978, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.218651, max_value=8.5604, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=-2.117099, max_value=-1.7743, exclude_min=True, allow_nan=False),
           st.floats(min_value=-4.674499, max_value=-2.22654, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.218651, max_value=8.5604, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=-0.403098, max_value=-0.258446, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.608219, max_value=5.453548, allow_nan=False),
           st.floats(min_value=1.0425, max_value=2.624649, allow_nan=False),
    ...
    @given(st.floats(min_value=-0.403098, max_value=-0.258446, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.608219, max_value=5.453548, allow_nan=False),
           st.floats(min_value=2.624652, max_value=5.685201, exclude_min=True, allow_nan=False),
           st.floats(min_value=-0.727056, max_value=1.228229, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.403098, max_value=-0.258446, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.608219, max_value=5.453548, allow_nan=False),
           st.floats(min_value=2.624652, max_value=5.685201, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.228232, max_value=1.472485, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=-0.403098, max_value=-0.258446, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.453551, max_value=5.8759, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=-5.189221, max_value=-4.726002, allow_nan=False),
           st.floats(min_value=7.565301, max_value=8.64256, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=-4.725999, max_value=-3.716767, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.565301, max_value=8.64256, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.320166, max_value=1.621092, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.99882, max_value=7.191799, allow_nan=False),
           st.floats(min_value=-4.56606, max_value=-4.386051, allow_nan=False),
    ...
    @given(st.floats(min_value=0.320166, max_value=1.621092, exclude_min=True, allow_nan=False),
           st.floats(min_value=7.191802, max_value=8.343761, exclude_min=True, allow_nan=False),
           st.floats(min_value=-4.56606, max_value=-4.386051, allow_nan=False),
    ...
    @given(st.floats(min_value=0.320166, max_value=0.574572, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.77874, max_value=5.666699, allow_nan=False),
           st.floats(min_value=-4.386048, max_value=-3.963279, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.320166, max_value=0.574572, exclude_min=True, allow_nan=False),
           st.floats(min_value=5.666702, max_value=7.123681, exclude_min=True, allow_nan=False),
           st.floats(min_value=-4.386048, max_value=-3.963279, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.320166, max_value=0.336305, exclude_min=True, allow_nan=False),
           st.sampled_from([-3.7454, 2.4769, 2.6963, 3.4184, 3.5488, 6.1416, 7.946, 9.0552, 10.4023, 11.4535]),
           st.floats(min_value=-2.272198, max_value=1.767721, exclude_min=True, allow_nan=False),
           st.floats(min_value=-1.644136, max_value=0.08188, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.400867, max_value=0.404697, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.420021, max_value=0.654456, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=0.320166, max_value=0.574572, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.092719, max_value=3.559173, allow_nan=False),
           st.floats(min_value=-2.272198, max_value=-1.447149, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.081883, max_value=0.555406, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.320166, max_value=0.574572, exclude_min=True, allow_nan=False),
           st.floats(min_value=3.559176, max_value=5.43766, exclude_min=True, allow_nan=False),
           st.floats(min_value=-2.272198, max_value=-1.447149, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.081883, max_value=0.555406, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=0.320166, max_value=0.574572, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=1.853052, max_value=5.067921, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.081883, max_value=0.555406, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=1.592201, max_value=1.68107, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.42354, max_value=6.472699, allow_nan=False),
           st.floats(min_value=-4.386048, max_value=-4.038509, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.592201, max_value=1.68107, exclude_min=True, allow_nan=False),
           st.floats(min_value=6.472702, max_value=7.768481, exclude_min=True, allow_nan=False),
           st.floats(min_value=-4.386048, max_value=-4.038509, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=1.592201, max_value=1.68107, exclude_min=True, allow_nan=False),
           ...
           st.floats(min_value=-2.648349, max_value=1.4668, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=2.036551, max_value=2.9942, exclude_min=True, allow_nan=False),
           st.sampled_from([-6.4748, -5.1153, -5.0325, -0.63321, 0.27727, 1.3781, 5.9947, 8.96, 10.3567, 10.8223]),
           st.floats(min_value=-4.386048, max_value=0.076641, exclude_min=True, allow_nan=False),
