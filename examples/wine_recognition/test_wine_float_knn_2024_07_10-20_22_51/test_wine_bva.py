...
def _setup(request):
    ...
    experiment_data_path = os.path.join(pathlib.Path(__file__).parent.resolve(), 'test_wine_bva_experiment_data.json')
...
class TestWineProperty:
    ...
    @given(st.sampled_from([12.51, 12.7, 12.87, 13.23, 13.32, 13.48, 13.52, 13.69, 13.73, 13.88]),
           ...
           st.floats(min_value=1.332, max_value=1.579, allow_nan=False),
           ...
           st.floats(min_value=0.844, max_value=0.9349, allow_nan=False),
           st.floats(min_value=1.945, max_value=2.113, allow_nan=False),
           st.floats(min_value=659.6, max_value=754.99, allow_nan=False))
    ...
    @given(st.sampled_from([11.62, 11.79, 12.25, 12.34, 12.51, 12.52, 12.6, 12.99, 13.49, 13.86]),
           ...
           st.floats(min_value=1.582, max_value=2.281, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=13.017, max_value=13.513, allow_nan=False),
           ...
           st.floats(min_value=0.9352, max_value=1.0901, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.945, max_value=2.113, allow_nan=False),
           st.floats(min_value=659.6, max_value=754.99, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=13.516, max_value=13.778, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([12.36, 12.6, 12.7, 12.81, 12.93, 13.16, 13.36, 13.69, 13.73, 14.16]),
           ...
           st.floats(min_value=0.704, max_value=0.794, allow_nan=False),
           ...
           st.floats(min_value=2.116, max_value=2.492, exclude_min=True, allow_nan=False),
           st.floats(min_value=659.6, max_value=754.99, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=12.745, max_value=13.173, allow_nan=False),
           ...
           st.floats(min_value=0.797, max_value=1.653, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=13.176, max_value=13.213, exclude_min=True, allow_nan=False),
    ...
    @given(st.floats(min_value=13.366, max_value=13.658, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([12.25, 12.85, 12.87, 12.88, 12.93, 12.96, 13.08, 13.27, 13.32, 13.71]),
           ...
           st.floats(min_value=1.8, max_value=2.164, allow_nan=False),
           ...
           st.floats(min_value=0.7384, max_value=0.8029, allow_nan=False),
           st.sampled_from([1.27, 1.29, 1.33, 1.48, 1.55, 1.64, 1.8, 1.82, 1.96, 2.31]),
           st.floats(min_value=755.01, max_value=940.0, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([11.45, 11.65, 11.66, 11.79, 12.0, 12.08, 12.42, 12.67, 12.69, 12.77]),
           ...
           st.floats(min_value=0.8032, max_value=0.9845, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([13.07, 13.16, 13.41, 13.48, 13.58, 13.72, 13.73, 13.88, 14.12, 14.75]),
           ...
           st.floats(min_value=122.4, max_value=135.49, allow_nan=False),
           st.sampled_from([2.2, 2.4, 2.42, 2.48, 2.53, 2.63, 2.85, 2.95, 3.0, 3.1]),
           st.floats(min_value=2.167, max_value=2.749, exclude_min=True, allow_nan=False),
    ...
    @given(st.sampled_from([11.65, 12.04, 12.16, 12.21, 12.29, 12.67, 12.7, 12.77, 12.99, 13.05]),
           ...
           st.floats(min_value=135.51, max_value=140.8, exclude_min=True, allow_nan=False),
